...
if ($_POST['mail_send']=='SEND'){	
	...
	//while($to_location_info = mysqli_fetch_array($to_location_qr)){		
		if($to_loc_email!=""){
			/*
			$message="To ".$to_loc_name.",/n";
			$message.="Respected Sir/Mam,/n/n";
			$message.="Location created successfully in RV Solutions./n";
			$message.="/n";
			################################ Design mail page ################################################################
			$message.="
						<div style='width:100%;'>
							<div style='font-size: 18px;'> <u> <span  style ='font-weight:800;' >Location Details </u> <div>
							<table>
								<tbody>
									...
									<tr style='text-align:left;font-weight:800;'>
										...
										<td style='width:20%;'>VIKAS</td>
									</tr>
									<tr style='text-align:left;font-weight:800;'>
										<td style='width:20%;'><label> Password : </label></td>
										<td style='width:20%;'>12345</td>
									</tr>
								</tbody>
							</table>
						</div>
			...
			#####################################################################################################
			$message.="<div style='text-align:left;' >With Best Regards,</div>";
