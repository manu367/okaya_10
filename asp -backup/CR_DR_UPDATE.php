...
$rs_cr  = mysqli_query($link1,"select sum(amount) as cr_amt from location_account_ledger where location_code='".ANE00002."' and crdr='CR' and transaction_type!='Amount Transfer to Security A/C' group by crdr")or die("Cr error1".mysqli_error($link1));
