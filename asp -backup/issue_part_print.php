      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2"><?=getAnyDetails($po_row['to_location'],"locusername","userloginid","locationuser_master",$link1)." (".$po_row['to_location'].")";?></td>                
              </tr>
              <tr>
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			if($po_row['to_stateid']==$po_row['from_stateid']){ $colspn=5; }else{ $colspn=5;}
			?>   
            	<tr>
