...
if($_REQUEST['pageid']=='repair')
{
echo "<script>window.close();</script>";	
	}
	else {

 header("location:job_list_edit_asp.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."".$pagenav."&smsmsg=".$sms_msg."&mobileno=".$phone1."&customer_id=".$customer_id."&imei_serial=".$imei_serial1."&email_id=".$email."&status=1");
	//exit;
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-body">
              	  ...
              	  <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <select name="customer_type" id="customer_type" class="form-control required" readonly required>
 ...
 <option value="">--Please Select--</option>
			<?php	while($br_cust = mysqli_fetch_array($check_cust)){
				...
				?>
                      ...
                      <div class="col-md-6">
 <select name="rep_location" id="rep_location" class="form-control required" required readonly>
 
 
                        <?php
                        $lctype_query="select location_code,locationname  from location_master where statusid='1' and location_code='".$job_row["current_location"]."' order by locationname";
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Customer Name <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                      	...
                      	<input name="customer_name" id="customer_name" type="text" value="<?=$row_customer['customer_name'];?>" class="form-control required" readonly />
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Address <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                        ...
                        <textarea name="address" id="address" required class="form-control" onkeypress = " return ( (event.keyCode ? event.keyCode : event.which ? event.which : event.charCode)!= 13);"  onContextMenu="return false" style="resize:vertical" readonly ><?=$row_customer['address1'];?></textarea>
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Landmark </label>
                      ...
                      <div class="col-md-6">
                        	...
                        	<input name="landmark" id="landmark" type="text" class="form-control " value="<?=$row_customer['landmark'];?>" readonly/> 
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Pincode  <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                              ...
                              <input name="pincode" type="text" class="digits form-control required"  maxlength="6" id="pincode" value="<?=$row_customer['pincode']?>" readonly >
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Contact No. <!--<span class="small">(For SMS Update)</span>--> <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="phone1" type="text" class="digits required form-control" required id="phone1" maxlength="10" onKeyPress="return onlyNumbers(this.value);" onBlur="return phoneN();" value="<?php if($row_customer['mobile']!=''){ echo $row_customer['mobile'];}else{ echo $_REQUEST['mobileno'];}?>" readonly >
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Alternate Contact No.</label>
                      ...
                      <input name="phone2" type="text" class="digits form-control " id="phone2" maxlength="10" value="<?=$row_customer['alt_mobile'];?>"readonly >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">State <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                         ...
                         <select name="locationstate" id="locationstate" class="form-control required"  onchange="get_citydiv();" required readonly>

                        

                          <?php 

						 $state_query="select stateid, state from state_master where countryid='1' and stateid='".$row_customer['stateid']."' order by state";
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Email</label>
                      ...
                      <div class="col-md-6">
                          ...
                          <input name="email" type="email" class="email form-control" id="email" value="<?=$row_customer['email'];?>" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">City <span class="red_small">*</span></label>
                       ...
                       <select name="locationcity" id="locationcity" class="form-control required" required readonly >
                   ...
                   <div class="col-md-6"><label class="col-md-6 custom_label">Residence No.</label>
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="res_no" type="text" class="digits form-control" id="res_no" value="<?=$row_customer['phone']?>" readonly>
 ...
 <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">GST No.</label>
                        ...
                        <div class="col-md-6" id="citydiv">
                         ...
                         <input name="gst_no" type="text" class=" form-control" id="gst_no" value="<?=$row_customer['gst_no']?>"  readonly >
                      </div>
                   ...
                   <div class="col-md-6"><label class="col-md-6 custom_label">Registration Name.</label>
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="reg_name" type="text" class=" form-control" id="reg_name" value="<?=$row_customer['reg_name']?>"readonly >
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Product <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                        ...
                        <?php $dept_query="SELECT * FROM product_master where status = '1'  order by product_name";
						  ...
						  <option value="<?=$br_dept['product_id']?>"<?php if($job_row['product_id'] == $br_dept['product_id']){ echo "selected";}?>><?php echo $br_dept['product_name']?></option>
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Brand <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
                       ...
                       <select name="brand" id="brand" class="form-control required" required>
						  ...
						  <option value="<?=$br_dept['brand_id']?>"<?php if($job_row['brand_id'] == $br_dept['brand_id']){ echo "selected";}?>><?php echo $br_dept['brand']?></option>
                      ...
                      <div class="col-md-6" id="modeldiv">
                        ...
                        <select name="modelid" id="modelid" class="form-control required" required>
                          ...
                          <?php
						  	...
						  	if($job_row['model_id']!=""){
							$model_det2 = explode("~",getAnyDetails($job_row['model_id'],"product_id,brand_id,model,make_doa,doa_days,out_warranty,wp","model_id","model_master",$link1));

						  ?>

                          <option value="<?=$job_row['model_id']."~".$model_det2['2']."~".$model_det2['6'];?>"><?=$model_det2['2']?></option>
	...
	<input name="imei_serial1" id="imei_serial1" type="text" value="<?=$job_row['imei']?>" class="form-control  "  readonly />
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Bill Purchase Date</label>
                      ...
                      <div style="display:inline-block;float:left;"><input type="text" class="form-control required" name="pop_date"  id="pop_date" style="width:150px;" value="<?php if($job_row['dop']!=''){ echo $job_row['dop'];?>  <?php }else{ echo "";}?>"   onChange="getdate4();" readonly></div><div style="display:inline-block;float:left;"><i class="fa fa-calendar fa-lg"></i></div>
  ...
  <div style="display:inline-block;float:left;"><input type="text" class="form-control " name="install_date"  id="install_date" style="width:150px;" value="<?=$product_det['installation_date'];?>"  <?php if($job_row['installation_date']!=''){?> readonly <?php }else{}?> ></div><div style="display:inline-block;float:left;"><i class="fa fa-calendar fa-lg"></i></div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Warranty status<span class="red_small">*</span></label>
                      ...
                      <div class="col-md-6">
						 <input name="warranty_status" id="warranty_status" type="text" value="<?=$job_row['warranty_status']?>" class="form-control " readonly/>
                      </div>
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Dealer Name </label>
                      ...
                      <div class="col-md-6">
                         	...
                         	<input name="dealer_name" id="dealer_name" type="text" value="<?=$job_row['dname']?>" class="form-control" readonly/>
				   ...
				   <div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label">Invoice No </label>
                      ...
                      <input name="invoice_no" id="invoice_no" type="text" value="<?=$job_row['inv_no']?>" class="form-control" readonly/>

                      </div>

                    </div>

                    <div class="col-md-6"><label class="col-md-6 custom_label">Call Source</label>

                      <div class="col-md-6">

                       <select name="call_type" id="call_type" class="form-control required" required readonly>
