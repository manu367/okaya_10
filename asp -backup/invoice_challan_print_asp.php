...
// echo "SELECT * FROM billing_master where challan_no='" . $docid . "' and from_location='".$_SESSION['asc_code']."'";
...
<!--	<page size="A4" layout="portrait"></page>-->
	...
	<page size="A4">
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
            ...
            <tr>
                ...
                <td width="15%" colspan="2"><?=$docid?></td>

                <td width="10%" colspan=""><strong><?=$str?> Date</strong></td>

                <td width="15%" colspan=""><?=dt_format($po_row['sale_date'])?></td>

                <td width="10%" colspan=""><strong>Docket No.</strong></td>

                <td width="15%" colspan=""><?=$po_row['docket_no']?></td>
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <thead>
              ...
              <td width="17%"><strong>Job No.</strong></td>
 ...
 <td><?php if($podata_row['type']=='P2C'){
 echo "Defective";}else {
echo $podata_row['type']; }?></td>
