...
$(document).ready(function() {
	var dataTable = $('#po-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/dispatchpopna-grid-data_asp.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-shopping-bag"></i> Against PO</h2>
      <?php if($_REQUEST['msg']){?>
          ...
          <div class="col-md-6"><label class="col-md-5 control-label">Location Name</label>
            <div class="col-md-6">
              <select name="location_code" id="location_code" class="form-control">
               <option value="">Please Select</option>
                <?php //echo  "select locationname, location_code from location_master where  location_code !='".$_SESSION['asc_code']."'  and  statusid = '1' ";
               
			$map_wh=mysqli_query($link1, "select locationname, location_code from location_master where  location_code !='".$_SESSION['asc_code']."'  and  statusid = '1' ");			
         ...
         <div class="form-group">
		  <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			<div class="col-md-5" align="left">
			   ...
			   ?>
               <a href="../wh/po_report.php?daterange=<?=$_REQUEST['daterange']?>&status=<?=$_REQUEST['status']?>" title="Export PO details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export PO details in excel"></i></a>
               <?php
				//}
				?>
            </div>
