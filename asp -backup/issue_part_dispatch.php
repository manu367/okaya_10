...
//// job details
$job_sql="SELECT * FROM part_demand where eng_id='".$docid."'";
...
<div class="container-fluid">
 <div class="row content">
   ...
   <div class="<?=$screenwidth?>">
      <h2 align="center"><i class="fa fa-shopping-bag"></i> Issue Parts</h2>
      <h4 align="center">PO No.- <?=$docid?></h4>
   <div class="panel-group">
	<form class="form-horizontal" role="form" name="frm1" id="frm1" action="issue_partdemand_save.php" method="post">
    <div class="panel panel-info table-responsive">
        <div class="panel-heading"><i class="fa fa-id-card fa-lg"></i>&nbsp;&nbsp;Part Details</div>
         <div class="panel-body">
          <table class="table table-bordered" width="100%">
            <tbody>
              <tr>
                <td width="20%"><label class="control-label">Location Name</label></td>
                <td width="30%"><?php echo $to  = getAnyDetails($docid,"locusername","userloginid","locationuser_master",$link1); echo $locinfo['locationname'];?></td>
     ...
     <div class="panel-heading"><i class="fa fa-id-card fa-lg"></i>&nbsp;&nbsp;PO Items Details</div>
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
			...
			$tot_reqqty = 0;
			$tot_pendqty = 0;
			 $podata_sql="SELECT * FROM part_demand where eng_id='".$docid."' and status='1'";
            ...
            <tr>
			 ...
			 <tr>
                <td align="center" colspan="11"><span id="errormsg" class="red_small"></span>
                   ...
                   <input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='part_issue_eng_job.php?<?=$pagenav?>'">
                 </td>
                </tr>
            </tbody>
          </table>
