...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/job-grid-data-repl-btr-sr-loc.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h3 align="center"><i class="fa fa-check-square"></i> Replacement Sr NO. Attache (Self) </h3>
      <?php if($_REQUEST['msg']){?>
        ...
        <div class="form-group">
         <div class="col-md-6"><label class="col-md-5 control-label"><?=$locationstr?></label>	  
			<div class="col-md-6">
                ...
                <?php
				$res_pro = mysqli_query($link1,"select location_code,locationname from location_master where locationtype in ('ASP','L3') and statusid='1' and location_code = '".$_SESSION['asc_code']."' order by locationname "); 
       ...
       <table  width="100%" id="joblist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr class="<?=$tableheadcolor?>">
			  ...
			  <th>Delivery Note Print</th>
			  <th>Pick Up Note Print</th>
            </tr>
          </thead>
          </table>
          </div>
