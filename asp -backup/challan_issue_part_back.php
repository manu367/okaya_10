...
$po_sql="SELECT * FROM stn_master where challan_no='".$docid."' ";
...
<div class="container-fluid">
 <div class="row content">
   ...
   <div class="<?=$screenwidth?>">
      <h2 align="center"><i class="fa fa-reply-all"></i>Issue Part Details </h2><br/>
        ...
        <div class="panel-heading">Party Information</div>
         <div class="panel-body">
          ...
          <table class="table table-bordered" width="100%">
            <tbody>
              <tr>
                <td width="20%"><label class="control-label">Issue To</label></td>
                <td width="30%">
				  <?php 
				  /// bill to party
				    echo  getAnyDetails($po_row['to_location'],"locationname","location_code","location_master",$link1);
				 // echo  getAnyDetails($po_row['to_location'],"locusername","userloginid","locationuser_master",$link1);?></td>
                <td width="20%"><label class="control-label">Issue  By</label></td>
                <td width="30%"><?php echo str_replace("~",",",getAnyDetails($po_row['from_location'],"locusername","userloginid","locationuser_master",$link1));?></td>
              </tr>
              <tr>
    ...
    <div class="panel panel-info table-responsive">
      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
            ...
            <?php
			$i=1;
			$podata_sql="SELECT * FROM stn_items where challan_no='".$docid."' ";
        ...
        <table class="table table-bordered" width="100%">
            ...
            <!--  <tr>  <form id="frm1" name="frm1" class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
              ...
              <tr>
                 ...
                 <td colspan="4" align="center"><input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='eng_stock_back.php?daterange=<?=$_REQUEST['daterange']?>&status=<?=$_REQUEST['status']?>&doc_type=<?=$_REQUEST['doc_type']?><?=$pagenav?>'"></td>
                </tr>
            </tbody>
          </table>
      </div><!--close panel body-->
