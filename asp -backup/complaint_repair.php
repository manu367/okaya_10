...
function change_stat(val){
	...
	if(val=='5'){
		...
		document.getElementById("demo_install").style.display="none";
		 document.getElementById("btr_form").style.display="none";
...
document.getElementById("closetype").className="  form-control";
		...
		////check repairable flag is Y or N
			...
			document.getElementById("replacement").style.display="none";
			document.getElementById("demo_install").style.display="none";
		    document.getElementById("btr_form").style.display="";
			document.getElementById("errmsg").innerHTML = "";
			document.getElementById("savejob").style.display="";
			var span1 = document.getElementById("handset_span");
...
/////////// function to get part on the basis of repair code
  ...
  function replace_type(val){
	  ...
	  $.ajax({
	    type:'post',
		url:'../includes/getAzaxFields.php',
		//data:{replacemodel_eng:val,modelcode1:'<?=$job_row['model_id']?>', eng_id:'<?=$job_row['eng_id']?>',locationcode:'<?=$_SESSION['asc_code']?>'},
		  data:{replacemodel_eng:val,modelcode1:'<?=$job_row['model_id']?>', eng_id:'<?=$job_row['eng_id']?>',locationcode:'<?=$_SESSION['asc_code']?>',brand_id:<?=$job_row['brand_id']?>},
		success:function(data){
	//	alert(data);
              	...
              	<div class="form-group">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> OCV <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="ocv_befor" id="ocv_befor1" type="text" value="<?=$result_btr_initial['ocv']?>" class="required form-control  " required>
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C1 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c1_befor" id="c1_befor1" type="text" value="<?=$result_btr_initial['c1']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C2 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c2_befor" id="c2_befor1" type="text" value="<?=$result_btr_initial['c2']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> C3 + Ve <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="c3_befor" id="c3_befor1" type="text" value="<?=$result_btr_initial['c3']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C4 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c4_befor" id="c4_befor1" type="text" value="<?=$result_btr_initial['c4']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C5 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c5_befor" id="c5_befor1" type="text" value="<?=$result_btr_initial['c5']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> C6 + Ve <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="c6_befor" id="c6_befor1" type="text" value="<?=$result_btr_initial['c6']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
			...
			<div class="panel panel-info" style="margin-top: 25px;">
              ...
              <div class="panel-body">
              	...
              	<div class="form-group">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> Total Charging Hours <span class="red_small">*</span></label>

                      <div class="col-md-4" id="modeldiv">

                       <input name="tot_chrg_hr" id="tot_chrg_hr" type="text" value="<?=$result_btr_final['charging_hour']?>" class="required form-control  " required placeholder="HH:MM" >
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">TOC <span class="red_small">*</span> </label>

                      <div class="col-md-4">
	<input name="toc" id="toc1" type="text" value="<?=$result_btr_final['toc']?>" class="required form-control  " required>
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">OCV <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="ocv_aftr" id="ocv_aftr1" type="text" value="<?=$result_btr_final['ocv']?>" class="required form-control  " required>
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> C1 + Ve <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="c1_aftr" id="c1_aftr1" type="text" value="<?=$result_btr_final['c1']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C2 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c2_aftr" id="c2_aftr1" type="text" value="<?=$result_btr_final['c2']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C3 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c3_aftr" id="c3_aftr1" type="text" value="<?=$result_btr_final['c3']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> C4 + Ve <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="c4_aftr" id="c4_aftr1" type="text" value="<?=$result_btr_final['c4']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
                  ...
                  <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C5 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c5_aftr" id="c5_aftr1" type="text" value="<?=$result_btr_final['c5']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">C6 + Ve <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c6_aftr" id="c6_aftr1" type="text" value="<?=$result_btr_final['c6']?>" class="required form-control  " required min="1.100" max="1.300" maxlength="5" style="width:62px;">
              ...
              <div class="panel-body">
              	...
              	<div class="form-group">
                    ...
                    <div class="col-md-6"><label class="col-md-6 custom_label" style="padding-left: 13px;"> Discharging Current <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="dischrg_current" id="dischrg_current1" type="text" value="<?=$result_btr_final['dischrg_current']?>" class="required form-control  " required  style="width: 61px;">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">Back Up Time <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="backup_time" id="backup_time1" type="text" value="<?=$result_btr_final['backup_time']?>" class="required form-control  " required style="width: 61px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">Test Result <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="test_result" id="test_result1" type="text" value="<?=$result_btr_final['test_result']?>" class="required form-control  " required>
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">Load In Watt <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="load_in_watt" id="load_in_watt1" type="text" value="<?=$result_btr_final['load_in_watt']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">Cut off voltage <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="c_off_volt" id="c_off_volt1" type="text" value="<?=$result_btr_final['cut_off_volt']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> PCV 1 <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="pcv1" id="pcv11" type="text" value="<?=$result_btr_final['pcv1']?>" class="required form-control  " required maxlength="5" style="width:62px;">
                  ...
                  <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">PCV 2 <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="pcv2" id="pcv21" type="text" value="<?=$result_btr_final['pcv2']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">PCV 3 <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="pcv3" id="pcv31" type="text" value="<?=$result_btr_final['pcv3']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
...
<div class="form-group">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> PCV 4 <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="pcv4" id="pcv41" type="text" value="<?=$result_btr_final['pcv4']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
                  ...
                  <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">PCV 5 <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="pcv5" id="pcv51" type="text" value="<?=$result_btr_final['pcv5']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
					 ...
					 <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">PCV 6 <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="pcv6" id="pcv61" type="text" value="<?=$result_btr_final['pcv6']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;"> PCV 7 <span class="red_small">*</span></label>
                      ...
                      <div class="col-md-4" id="modeldiv">
                       ...
                       <input name="pcv7" id="pcv71" type="text" value="<?=$result_btr_final['pcv7']?>" class="required form-control  " required  maxlength="5" style="width:62px;">
                  ...
                  <div class="col-md-6"><label class="col-md-6 custom_label" style="padding-left: 12px;">Invertor Load Test Result <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-6">
						  ...
						  <select name="invt_load_tst_reslt" id="invt_load_tst_reslt"  class="  form-control" style="width:250px;">
...
<?php } ?>	
              ...
              <div class="form-group">
				...
				<div id="btr_form" style="display:none;">	  
		<?php 
...
<div class="panel panel-info" style="margin-top: 25px;">
	...
	<input name="backup_time" id="backup_time" type="text" value="<?=$result_btr_final['backup_time']?>" class="required form-control  " required style="width: 61px;">
                    ...
                    <div class="col-md-4"><label class="col-md-4 custom_label" style="padding-left: 13px;">Test Result <span class="red_small">*</span> </label>
                      ...
                      <div class="col-md-4">
	<input name="test_result" id="test_result" type="text" maxlength="4" value="<?=$result_btr_final['test_result']?>" class="required form-control  " required>
