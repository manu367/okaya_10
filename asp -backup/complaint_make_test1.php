...
<link rel="stylesheet" href="../css/bootstrap-select.min.css">
 ...
 <script>
   $(document).ready(function(){
	 ...
	 //alert('ddddddd');
		  if(locationstate=='' || customer_type=='' || pincode=='' || locationstate=='' || locationcity=='' || address==''){
  ...
  <div class="row content">
    ...
    <div class="<?=$screenwidth?>">
      ...
      <?php } ?>
		...
		<form  name="frm2" id="frm2" class="form-horizontal" enctype="multipart/form-data" autocomplete="off" onsubmit="return really('save')" action="" method="post">
 ...
 <!-- <div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-12" align="center">
                      ...
                      <input type="submit" class="btn<?=$btncolor?>" name="savecustomer" id="savecustomer" value="Save" title="Save Job Details" <?php if($_POST['savecustomer']=='Save'){?>disabled<?php }?>>&nbsp;
