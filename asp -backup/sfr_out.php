...
$arrstatus = getFullStatus("Dispatch",$link1);
...
$(document).ready(function() {
	var dataTable = $('#sfr_outlist-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/sfr_out-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$("sfr_out-grid-error").html("");
				$("#sfr_out-grid").append('<tbody class="sfr_out-grid-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
				$("#sfr_out-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-list-alt"></i> SFR OUT </h2>
      <?php if($_REQUEST['msg']){?>
	...
	?>
       ...
       <table  width="100%" id="sfr_outlist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              <th>S.No</th>
              <th>Document No.</th>
