      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
			...
			while($podata_row=mysqli_fetch_assoc($podata_res)){
				$proddet=explode("~",getAnyDetails($podata_row['partcode'],"part_name,product_id,brand_id,hsn_code","partcode","partcode_master",$link1));
			?>
              <tr>
                <td><?=$i?></td>
      ...
      <div class="panel-body">
        <table class="table table-bordered" width="100%">
            <tbody>
			  ...
			  <?php }?>
              <tr>
                 <td colspan="4" align="center"><input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='billing_invoice_list.php?<?=$pagenav?>'"></td>
                </tr>
            </tbody>
          </table>
      </div><!--close panel body-->
