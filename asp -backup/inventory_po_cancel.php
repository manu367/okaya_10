...
if($_POST){
  ...
  ///// move to parent page
 header("Location:inventory_po.php?msg=".$msg."".$pagenav);
  exit;
}
     ...
     <div class="panel-heading"><i class="fa fa-id-card fa-lg"></i>&nbsp;&nbsp;PO Items Details</div>
       ...
       <table class="table table-bordered" width="100%">
			...
			?>
              <tr>
                <td><?=$i?></td>
                <td><?=$proddet[0]." (".$podata_row[product_id].")"?></td>
                <td><?=$brand[0]." (".$podata_row[brand_id].")"?></td>
                <td><?=$model[0]." (".$podata_row[model_id].")"?></td>
            ...
            <tbody>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input title="Back" type="button" class="btn btn-primary" value="Back" onClick="window.location.href='inventory_po.php?<?=$pagenav?>'">
                  </td>
                </tr>
            </tbody>
          </table>
