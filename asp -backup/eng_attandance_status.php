...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-bank"></i> Enigeer Attandence</h2>
      <?php if($_REQUEST['msg']){?>
	    ...
	    <div class="form-group">
         <div class="col-md-6"><label class="col-md-5 control-label"> Status</label>	  
		  ...
		  <div class="col-md-6">  
			   ...
			   ?>
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	<a href="excelexport.php?rname=<?=base64_encode("bankmaster")?>&rheader=<?=base64_encode("Attendance Master")?>&status=<?=$_REQUEST['status']?>" title="Export bank details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export bank details in excel"></i></a>
               <?php
					}
				?>
          </div>
