...
<td><div align="center"><a href="complaint_make.php?customer_id=<?=$customerid_arr[$k]?>&mobileno=<?=$_REQUEST['mobileno']?>&email_id=<?=$_REQUEST['email_id']?>&imei_serial=<?=$serial_arr[$k]?>&id=<?=$id_arr[$k]?>"".$pagenav." title='view'><i class='fa fa-eye fa-lg faicon' title='view job details'></i></a></div></td>
...
<input title="Make complaint with serial" type="button" id="makecomplaint" name="makecomplaint" class="btn<?=$btncolor?>" value="Create Complaint"  onClick="window.location.href='complaint_make_test.php?<?=$pagenav?>&mobileno=<?=$_REQUEST['mobileno']?>&customer_id=<?=$_REQUEST['customer_id']?>&email_id=<?=$_REQUEST['email_id']?>&imei_serial=<?=$_REQUEST['imei_serial']?>'">
