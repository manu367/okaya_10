...
<div class="container-fluid">
 <div class="row content">
   ...
   <div class="<?=$screenwidth?>">
      <h2 align="center"><i class="fa fa-shopping-bag"></i> Dispatch Location PO</h2>
      <h4 align="center">PO No.- <?=$docid?></h4>
   <div class="panel-group">
	<form class="form-horizontal" role="form" name="frm1" id="frm1" action="dispatch_pnapo_save_asp.php" method="post">
            ...
            <tr>
			 ...
			 <tr>
                <td align="center" colspan="10"><span id="errormsg" class="red_small"></span>
                   ...
                   <input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='dispatch_pna_po_asp.php?<?=$pagenav?>'">
                 </td>
                </tr>
            </tbody>
          </table>
