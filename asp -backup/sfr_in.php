...
$(document).ready(function() {
	var dataTable = $('#sfr_in_asclist-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/sfr_in_asc-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".sfr_in_asc-grid-error").html("");
				$("#sfr_in_asc-grid").append('<tbody class="sfr_in_asc-grid-error"><tr><th colspan="9">No data found in the server</th></tr></tbody>');
				$("#sfr_in_asc-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
        ...
        <div class="form-group">
         <div class="col-md-6"><label class="col-md-5 control-label"><?=$locationstr?></label>	  
			<div class="col-md-6">
                ...
                <?php
                $res_pro = mysqli_query($link1,"select location_code,locationname from location_master where location_code in (select repair_location from map_repair_location where location_code='".$_SESSION['asc_code']."')"); 
	...
	?>
       ...
       <table  width="100%" id="sfr_in_asclist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              <th>S.No</th>
              <th>Document No.</th>
