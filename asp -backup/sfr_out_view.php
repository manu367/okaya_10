			   ...
			   <tr>
                        <td colspan="8"><strong>Bill To :</strong><br>
                          ...
                          <td colspan="8"><strong>Ship To :</strong><br>
                              <b>
                              <?=$row['to_location']?>
                              </b><br><?=$row['to_address']?><br><?=$row['to_state']?><br>GSTIN No.-<b><?=$row['to_gst_no']?></b></td>
                        </tr>
            <tr>
              <td>S.No</td>
          ...
          <tbody>
			...
			<tr>
						...
						<tr>
                            ...
                            <a href='sfr_invoice_print.php?id="<?=base64_encode($_REQUEST['challan_no'])?>' target='_blank' title='Print SFR Challan'><i class='fa fa-print fa-lg faicon' title='Print SFR Challan'></i></a>
                            </td>
                        </tr>
          </tbody>
          </table>
