							  ...
							  while($row_maintab=mysqli_fetch_assoc($res_maintab))
							  {
								  ...
								  if($num_subtab > 0)
								  {
									  ...
									  ?>
						  				...
						  				<span class="ag-courses-item_link" style="text-align:center;font-size:14px;font-weight:bold;background:#2e353d;"><span><i class="fa <?=$icon_m;?> fa-lg" style="font-size:14px;display:inline-block;line-height: 20px;"></i><b style="color:#fff;padding-left:4px;vertical-align:bottom;font-family:NDot;letter-spacing:2px;"><?=$name_m;?></b></span></span>
						  				<?php
