...
$(document).ready(function() {
	var dataTable = $('#asc-grnlocal-grid').DataTable( {
		...
		"order": [[ 4, "desc" ]],
		"ajax":{
			url :"../pagination/partassgin-grid-data_asp_back.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-car"></i>&nbsp;Stock Receive From Engineer (Direct)</h2>
    <?php if($_REQUEST['msg']){?>
      ...
      <form class="form-horizontal" role="form">
        <button title="Spare Return" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_spare_return.php?op=Add<?=$pagenav?>'"><span>Receive Part</span></button><br/><br/>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
        <div class="form-group"  id="page-wrap" style="margin-left:10px;">
            
&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <button title="Spare Return" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_spare_return_faulty.php?op=Add<?=$pagenav?>'"><span>Faulty Receive Part</span></button>
