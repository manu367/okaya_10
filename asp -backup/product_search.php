...
$(document).ready(function() {
	var dataTable = $('#product-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/product-grid-asc.php", // json datasource
			...
			error: function(){  // error handling
				...
				$("#product-grid").append('<tbody class="product-grid-error"><tr><th colspan="6">No data found in the server</th></tr></tbody>');
				$("#product-grid_sectioning").css("display","none");
  ...
  <div class="row content">
   ...
   include("../includes/leftnavemp2.php");
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-gears"></i> Product Search</h2>
      <?php if($_REQUEST['msg']){?>
