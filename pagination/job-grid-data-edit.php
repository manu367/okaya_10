...
$sql = "SELECT *";
$sql.=" FROM jobsheet_data where 1";
...
while( $row=mysqli_fetch_array($query) ) {  
	$nestedData=array();	
	if($row["customer_id"]!=""){
	$job_edit="<div align='center'><a href='complaint_edit.php?refid=".base64_encode($row['job_no'])."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view Job details'></i></a></div>";
	}else{
	$job_edit="<div align='center'><a href='job-no-edit.php?refid=".base64_encode($row['job_no'])."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view Job details'></i></a></div>";
	}
	$nestedData[] = $j; 
