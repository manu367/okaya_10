...
$sql = "SELECT *";
$sql.=" FROM pincode_master where 1";
...
// if there is a search parameter, $requestData['search']['value'] contains search parameter
	...
	$sql.=" AND ( area LIKE '".$requestData['search']['value']."%'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='add_pincode.php?op=Edit&id=".$row['id']."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view/edit city details'></i></a></div>";
