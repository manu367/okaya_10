...
$sql = "SELECT *";
$sql.=" FROM audit_details where location_code='".$_SESSION['asc_code']."' and ".$status."  and  ".$daterange." and  ".$type." ";
...
$str = "<div><a href='auditDetailsasp.php?request_no=".base64_encode($perv_result['request_no'])."" .$pagenav."''>".$perv_result['request_no']."</a></div> ";
 ...
 // preparing an array
	...
	$nestedData[] ="<div align='center'><a href='view_audit_details_asp.php?request_no=".base64_encode($row['request_no'])."" .$pagenav."'' title='view'><i class='fa fa-eye fa-lg faicon' title='view/edit  details'></i></a></div>" ;
	$data[] = $nestedData;
	$j++;
}
