...
// getting total number records without any search
  $sql = "SELECT *";
$sql.=" FROM jobsheet_data where  	location_code ='".$_SESSION['asc_code']."' and ".$status." and ".$daterange." and " .$model_id;
...
$sql = "SELECT *";
  $sql.=" FROM jobsheet_data where location_code ='".$_SESSION['asc_code']."'  and  ".$status."  and ".$model_id;
