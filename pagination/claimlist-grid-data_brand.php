...
$sql.=" FROM billing_master where  ".$status." and claim_month like '%$sel_month%'  and ".$locationcode." and ( po_type ='ENTITY LABOUR CLAIM' or po_type='ENTITY TRAVEL CLAIM')";
 ...
 // preparing an array
	...
	if($row["disp_rmk"]==''){
		...
		$nestedData[] = $row["disp_rmk"];
			...
			if ( $row['po_type']=="ENTITY LABOUR CLAIM" ){
