...
// getting total number records without any search
  $sql = "SELECT *";
$sql.=" FROM jobsheet_data where  	location_code ='".$_SESSION['asc_code']."' and ".$status." and ".$daterange." and brand_id in (".$access_brand.") and " .$model_id;
...
$sql = "SELECT *";
  $sql.=" FROM jobsheet_data where location_code ='".$_SESSION['asc_code']."'  and  ".$status." and brand_id in (".$access_brand.")  and ".$model_id;
