...
$sql = "SELECT *";
$sql.=" FROM location_master where statusid=3";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='app_location.php?id=".base64_encode($row['locationid'])."&status=".$_REQUEST['status']."".$pagenav."' title='Take Approval Action'><i class='fa fa-eye fa-lg faicon' title='Take Approval Action for ".$locationstr."'></i></a></div>";
