...
$sql.=" FROM supplier_po_master where 1 ";
$query=mysqli_query($link1, $sql) or die("admin-approval-grid-data.php: get  details");
...
while( $row=mysqli_fetch_array($query) ) { 
 ...
 // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='adminapproval_view.php?refid=".base64_encode($row['system_ref_no'])."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view approval details'></i></a></div>";
