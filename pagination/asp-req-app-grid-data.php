...
$sql =  "SELECT sno,request_no,requestdate,status,city,state,name,app_status";
$sql.=" FROM asc_appo_request where   ".$locationstate." and ".$city." and ".$daterange." ";
...
while( $row=mysqli_fetch_array($query) ) { 
 ...
 // preparing an array
	...
	$nestedData[] = (($row["app_status"] == '14')?"<div align='center'><a href='asp_req.php?request_no=".base64_encode($row['request_no'])."".$pagenav."' target='_blank' title='print'><i class='fa fa-eye fa-lg faicon' title='print document details'></i></a></div>":"-");
