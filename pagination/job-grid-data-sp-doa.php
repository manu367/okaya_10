...
$sql = "SELECT *";
$sql.=" FROM jobsheet_data where (job_no LIKE '".$requestData['search']['value']."' OR imei LIKE '".$requestData['search']['value']."')";
...
if($totalFiltered>0) {  // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='doa-approval-sp-doa.php?refid=".base64_encode($row['job_no'])."".$pagenav."' title='view'><i class='fa fa-eye fa-lg faicon' title='view Job details'></i></a></div>";
