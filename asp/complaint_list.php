...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/complaint-grid-data.php", // json datasource
...
<script>
    ...
    ComplaintList.prototype.setUrl=function(url){
        this.url=url;
    }
    ComplaintList.prototype.requestData=async function (){
        let data={ "pid": "<?=$_REQUEST['pid']?>",
            "hid": "<?=$_REQUEST['hid']?>",
