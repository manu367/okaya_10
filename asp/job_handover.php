...
if($_POST){
	if ($_POST['hando']=='Confirm' && $docid!=''){
		//// initialize transaction parameters
		$flag = true;
		mysqli_autocommit($link1, false);
		$error_msg = "";
		////// update in jobsheet data
    	$sql_update = "UPDATE jobsheet_data set status ='10', sub_status ='10', hand_date ='".$today."',hand_time='".$currtime."',recipient_name='".$recipient_name."',recipient_contact='".$recipient_no."',service_rmak='".$remark."',rating='".$rating."' where job_no ='".$docid."' ";
		...
		$flag = callHistory($docid,$_SESSION['asc_code'],"10","Call Confirmed","Call Confirmed By customer",$_SESSION['userid'],$job_row['warranty_status'],"","","",$ip,$link1,$flag);
		////// insert in activity table////
		$flag = dailyActivity($_SESSION['userid'],$docid,"Job","Confirmed",$ip,$link1,$flag);
		///// check if all query are successfully executed
		if ($flag) {
			mysqli_commit($link1);
			$cflag = "success";
			$cmsg = "Success";
			$msg="Job <strong>".$docid."</strong> is successfully Confirm by customer.";
		} else {
		...
		mysqli_close($link2);
		 header("location:job_list.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."&job_status=".$_REQUEST['job_status']."".$pagenav);
    exit;
	}
   	///// move to parent page
...
<div class="container-fluid">
 <div class="row content">
    ...
    include("../includes/leftnavemp2.php");
		$cust_det = explode("~",getAnyDetails($job_row['customer_id'],"customer_id,landmark,email,phone,dob_date,mrg_date","customer_id","customer_master",$link1));
	$product_det = mysqli_fetch_assoc(mysqli_query($link1,"SELECT * FROM product_registered  where job_no='".$job_row['job_no']."'"));
    ?>
   <div class="<?=$screenwidth?>">
      <h2 align="center"><i class="fa fa-handshake-o"></i> Call Confirmation</h2>
   ...
   <div class="panel-group">
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading"><i class="fa fa-handshake-o fa-lg"></i>&nbsp;&nbsp;Call Confirmation</div>
      <div class="panel-body">
		<form id="frm1" name="frm1" class="form-horizontal" action="" method="post">
          <div class="form-group">
            <div class="col-md-10"><label class="col-md-4 control-label">Confirm By <span class="red_small">*</span></label>
              <div class="col-md-6">
          ...
          <div class="form-group">
            <div class="col-md-10"><label class="col-md-4 control-label"> Contact No. <span class="red_small">*</span></label>
              <div class="col-md-6">
                 <input type="text" name="recipient_no" class="required number form-control" id="recipient_no" maxlength="10" required/>
              </div>
            </div>
          </div>
		        <div class="form-group">
            <div class="col-md-10"><label class="col-md-4 control-label"> Remark <span class="red_small">*</span></label>
              <div class="col-md-6">
                 <input type="text" name="remark" class="required  form-control" id="remark" required/>
              </div>
            </div>
          </div>
		  <div class="form-group">
            <div class="col-md-10"><label class="col-md-4 control-label"> Service Rating  <span class="red_small">*</span></label>
              <div class="col-md-6">
              
				 
				 <select name="rating" id="rating" class="form-control required"  required style="width:200px;">
          ...
          <div class="form-group">
            <div class="col-md-12" align="center">
              <input type="submit" class="btn<?=$btncolor?>" name="hando" id="hando" value="Confirm" title="Confirm By Customer " <?php if($_POST['hando']=='Confirm'){?>disabled<?php }?>>&nbsp;&nbsp;&nbsp;
