...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/job-grid-data_asp.php", // json datasource
			data: { "pid": "<?=$_REQUEST['pid']?>", "hid": "<?=$_REQUEST['hid']?>", "daterange": "<?=$_REQUEST['daterange']?>", "info": info, "product_name": "<?=$_REQUEST['product_name']?>", "brand": "<?=$_REQUEST['brand']?>", "location_code": "<?=$_REQUEST['location_code']?>", "modelid": "<?=$_REQUEST['modelid']?>","job_status":"<?=$_REQUEST['job_status']?>"},
         		...
         		<div class="col-md-6"><label class="col-md-5 control-label">Date Range</label>	  
		  		...
		  		<div class="col-md-6"><label class="col-md-4 control-label">Job Status</label>	  
					<div class="col-md-5" align="left">
                        ...
                        <option value="" <?php if($_REQUEST['job_status'] == ""){ echo "selected";}?> >Please Select</option>
                         <option value="all" <?php if($_REQUEST['job_status'] == "all"){ echo "selected";}?> >All Call</option>
                    	<option value="open" <?php if($_REQUEST['job_status'] == "open"){ echo "selected";}?> >Open Call</option>
                        <option value="close" <?php if($_REQUEST['job_status'] == "close"){ echo "selected";}?> >Closed Call</option>
               </select>
            		</div>
          		</div>
