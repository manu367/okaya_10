...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-pencil-square-o"></i>Sale Return</h2>
	...
	?>
        <div class="form-group">
		  <div class="col-md-6"><label class="col-md-4 control-label"></label>	  
           ...
           <span>Partwise Sale Report</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../excelReports/salepartwiseasp_report.php?daterange=<?=$_REQUEST['daterange']?>&prod_code=<?=base64_encode($prostr);?>&brand=<?=base64_encode($brandstr);?>&model=<?=base64_encode($modelstr);?>" title="Export Sale Report in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export Sale Report details in excel"></i></a>
		   </div>
          </div>
		   <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			<div class="col-md-5">             
		   <span>Detailed Sale Report</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="../excelReports/saledetailasp_report.php?daterange=<?=$_REQUEST['daterange']?>&prod_code=<?=base64_encode($prostr);?>&brand=<?=base64_encode($brandstr);?>&model=<?=base64_encode($modelstr);?>" title="Export Sale Report in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export Sale Report details in excel"></i></a>
            </div>
          </div>
	    </div><!--close form group-->
        <?php }?>
