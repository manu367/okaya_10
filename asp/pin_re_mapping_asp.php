	...
	for($row =2 ;$row <= $highest;$row++){
		...
		if($check_pin_master['area']!=""){
			...
			if($check_loc!=""){
				...
				///// move to parent page
				header("location:pin_re_mapping_asp.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."".$pagenav);
				exit;
			}
  ...
  <div class="row content">
   ...
   include("../includes/leftnavemp2.php");
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      ...
      <div style="display:inline-block;float:right"><span class="red_small">Download Template : </span><a href="../templates/PINCODE_MAPPING_ENG.xlsx" title="Download Excel Template"><img src="../images/template.png" title="Download Excel Template"/></a></div>	<br></br> 
