...
//////////////////////////////// update SFR Transaction//////////////////////////////////////
 ...
 //////////////////////////////// update SFR Bin//////////////////////////////////////
  $up_sfr_bin=mysqli_query($link1,"update sfr_repaired_bin set status='415'  where job_no='".$_POST[$job_b]."'" );
   //////////////////////////////// update call  history//////////////////////////////////////
    $flag2 = callHistory($_POST[$job_b],$_SESSION['asc_code'],"415","SFR Received at ASP","SFR Received at ASP",$_SESSION['userid'],"","","","",$ip,$link1,$flag);
	////////////////////////////////////////////SFR Challan /////////////////////////////////////////////////////
	//echo "update sfr_challan set  receive_date='".$today."',status='4'  where challan_no='".$_REQUEST['challan_no']."'";
	  ...
	  /////////////////////////////////////Job Sheet data////////////////////////////////////////////////////////
	 // echo "update jobsheet_data set status='419',current_location='".$_SESSION['asc_code']."'  where job_no='".$_POST[$job_no]."'";
   $up_job=mysqli_query($link1,"update jobsheet_data set status='6' ,sub_status='415',current_location='".$_SESSION['asc_code']."'  where job_no='".$_POST[$job_b]."'" );
}
  ...
  $up_sfr_bin=mysqli_query($link1,"update sfr_repaired_bin set status='415'  where job_no='".$_POST[$job_b]."'" );
   //////////////////////////////// update call  history//////////////////////////////////////
	...
	////////////////////////////////////////////SFR Challan /////////////////////////////////////////////////////
	  ...
	  /////////////////////////////////////Job Sheet data////////////////////////////////////////////////////////
   $up_job=mysqli_query($link1,"update jobsheet_data set status='6' ,sub_status='415',current_location='".$_SESSION['asc_code']."' where  where job_no='".$_POST[$job_b]."'" );
}
/////////////////////////////SFR Missing////////////////////////////////////////////////////////
...
//////////////////////////////// update SFR Transaction//////////////////////////////////////
 $up_sfr_trac=mysqli_query($link1,"update sfr_transaction set rec_type='".$_POST[$status_b]."'  where sno='".$row['sno']."'" );
 //////////////////////////////// update SFR Bin//////////////////////////////////////
  $up_sfr_bin=mysqli_query($link1,"update sfr_repaired_bin set status='421M'  where job_no='".$_POST[$job_b]."'" );
   //////////////////////////////// update call  history//////////////////////////////////////
    $flag2 = callHistory($_POST[$job_b],$_SESSION['asc_code'],"415","SFR Missing at ASP","SFR Missing at ASP",$_SESSION['userid'],"","","","",$ip,$link1,$flag);
	////////////////////////////////////////////SFR Challan /////////////////////////////////////////////////////
   ...
   $msg = "Error details2.1: " . mysqli_error($link1) . ".";
    mysqli_rollback($link2);
 	mysqli_close($link1);
 header("location:sfr_in.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."".$pagenav);
  }
    else if (!$up_sfr_bin) {
    $flag = false;
