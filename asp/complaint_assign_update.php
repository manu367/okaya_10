...
$error_msg="";
   ...
   //////////////////////////////// Insert call  history//////////////////////////////////////
    $flag2 = callHistory($_POST['job_no'],$_SESSION['asc_code'],"2","Assigned to Engineer","Assigned to Engineer",$eng_name,$ws,$_REQUEST['els_status'],"","",$ip,$link1,$flag);

	  
	  /////////////////////////////////////Job Sheet data////////////////////////////////////////////////////////
	 
   $up_job=mysqli_query($link1,"update jobsheet_data set sub_status='2',status='2',eng_id='".$eng_name."' ,pen_status='2' where job_no='".$_POST['job_no']."'" );
