...
$(document).ready(function(){
	$("#barcodeprint").barcode(
		"DEM000010001", // Value barcode (dependent on the type of barcode)
		"code128" // type (string)
/* Types
codabar
code11 (code 11)
        ...
        <table class="table" border="1">
            <tbody>
              <tr>
                ...
                <td width="35%"><?=$job_row['open_date']." ".$job_row['open_time']?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3"><?php echo $job_row['cust_problem']."&nbsp;&nbsp;/&nbsp;&nbsp;".$job_row['cust_problem2']."&nbsp;&nbsp;/&nbsp;&nbsp;".$job_row['cust_problem3']?></td>
              </tr>
              <tr>
