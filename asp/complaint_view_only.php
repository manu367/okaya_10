...
<?php 
	...
	$cust_det = explode("~",
            getAnyDetails($job_row['customer_id'],
                    "customer_id,landmark,email,phone,dob_date,mrg_date,alt_mobile ",
                    "customer_id",
                    "customer_master",$link1));
//    var_dump($cust_det);exit();
...
<style>
    ...
    <script>
        const img_tag=document.querySelectorAll("#frm1 table .col-md-6 img");
        console.log(img_tag);
        img_tag.forEach((img)=>{
