...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//	echo "UPDATE jobsheet_data set status='".$_POST['jobstatus']."', sub_status='".$_POST['jobstatus']."', app_reason='".$_POST['app_req']."' where job_no='".$jobno."'";
			...
			// BTR proccess start - 14-08-2025
			
			$sql_btr="select id from initial_btr_data where job_no='".$jobno."'";
	            $result_btr=mysqli_query($link1,$sql_btr);
				$sql_btr_f="select id from final_btr_data where job_no='".$jobno."'";
	            $result_btr_f=mysqli_query($link1,$sql_btr_f);
				//print_r(mysqli_num_rows($result_btr));exit;
				//print_r($_POST);exit;
				if ((mysqli_num_rows($result_btr)==0) ){	
	//print_r($_POST);exit;
	            $btr_add="INSERT INTO initial_btr_data set job_no='".$jobno."',c1='".$_POST['c1_befor']."',c2='".$_POST['c2_befor']."',c3='".$_POST['c3_befor']."',c4='".$_POST['c4_befor']."',c5='".$_POST['c5_befor']."',c6='".$_POST['c6_befor']."',ocv='".$_POST['ocv_befor']."',eng_id='',entry_date='".$today."',entry_time='".$today_time."',ip='".$ip."'";
			   ...
			   if (!$res_addt) {
				...
				}else if((mysqli_num_rows($result_btr)>0)){
				
				 $btr_upd="UPDATE initial_btr_data set c1='".$_POST['c1_befor']."',c2='".$_POST['c2_befor']."',c3='".$_POST['c3_befor']."',c4='".$_POST['c4_befor']."',c5='".$_POST['c5_befor']."',c6='".$_POST['c6_befor']."',ocv='".$_POST['ocv_befor']."',eng_id='' where job_no='".$jobno."'";	
	            ...
	            $btr_add_f="INSERT INTO final_btr_data set job_no='".$jobno."',c1='".$_POST['c1_aftr']."',c2='".$_POST['c2_aftr']."',c3='".$_POST['c3_aftr']."',c4='".$_POST['c4_aftr']."',c5='".$_POST['c5_aftr']."',c6='".$_POST['c6_aftr']."',toc='".$_POST['toc']."',charging_hour='".$_POST['tot_chrg_hr']."',backup_load='".$bkp_load."',backup_time='".$_POST['backup_time']."',eng_id='',dischrg_current='".$_POST['dischrg_current']."',test_result='".$_POST['test_result']."',load_in_watt='".$_POST['load_in_watt']."',cut_off_volt='".$_POST['c_off_volt']."',pcv1='".$_POST['pcv1']."',pcv2='".$_POST['pcv2']."',pcv3='".$_POST['pcv3']."',pcv4='".$_POST['pcv4']."',pcv5='".$_POST['pcv5']."',pcv6='".$_POST['pcv6']."',pcv7='".$_POST['pcv7']."',invt_load_tst_reslt='".$_POST['invt_load_tst_reslt']."',entry_date='".$today."',entry_time='".$today_time."',ip='".$ip."',ocv='".$_POST['ocv_aftr']."',use_load='".$use_load."'";
	
	            $res_addt_f=mysqli_query($link1,$btr_add_f);
				 if (!$res_addt_f) {
				 $flag = false;
				 $error_msg = "Error After Btr details: " . mysqli_error($link1) . ".";
			   }	
				}else if((mysqli_num_rows($result_btr_f)>0)){	
					
				$btr_upd_f="UPDATE final_btr_data set c1='".$_POST['c1_aftr']."',c2='".$_POST['c2_aftr']."',c3='".$_POST['c3_aftr']."',c4='".$_POST['c4_aftr']."',c5='".$_POST['c5_aftr']."',c6='".$_POST['c6_aftr']."',toc='".$_POST['toc']."',charging_hour='".$_POST['tot_chrg_hr']."',backup_load='".$bkp_load."',backup_time='".$_POST['backup_time']."',eng_id='',dischrg_current='".$_POST['dischrg_current']."',test_result='".$_POST['test_result']."',load_in_watt='".$_POST['load_in_watt']."',cut_off_volt='".$_POST['c_off_volt']."',pcv1='".$_POST['pcv1']."',pcv2='".$_POST['pcv2']."',pcv3='".$_POST['pcv3']."',pcv4='".$_POST['pcv4']."',pcv5='".$_POST['pcv5']."',pcv6='".$_POST['pcv6']."',pcv7='".$_POST['pcv7']."',invt_load_tst_reslt='".$_POST['invt_load_tst_reslt']."',ip='".$ip."',ocv='".$_POST['ocv_aftr']."',use_load='".$use_load."' where job_no='".$jobno."'";
		...
		$res_jobsheet = mysqli_query($link1,"UPDATE jobsheet_data set status='".$status."', sub_status='".$status."', app_reason='".$_POST['app_req']."',repl_req_flag='".$repl_req_flag."' where job_no='".$jobno."'");
...
$max_rep=mysqli_query($link1,"insert into job_claim_appr set job_no='".$jobno."',brand_id='".$job_details['brand_id']."',action_by='".$_SESSION['asc_code']."',rep_lvl ='".$row_level['b']."',model='".$job_details['model_id']."',product_id='".$job_details['product_id']."',entity_type='".$job_details['entity_type']."',eng_name='".$row_max['updated_by']."',hand_date='".$today."',travel_km='".$row_max[a]."',area_type='".$job_details['area_type']."',claim_tat='".$close_tat."',hrs_tat='".$gethrs."',job_count='".$job_details['job_count']."' ");
	...
	$st_status=2;
	        ...
	        if($_POST['jobstatus'] == "50" && $_POST['app_req']=="Replacement"){
				$status = '81';
				$substatus = '8';
	        }else{
				$status = $_POST['jobstatus'];
			    $substatus = $_POST['jobstatus'];
			}
	if($job_details['call_for']=='PicknDrop'){	$res_jobsheet = mysqli_query($link1,"UPDATE jobsheet_data set imei='".$_POST['serial_no']."',status='".$status."', sub_status='".$substatus."' ".$upd_str.",new_part='".$_POST['stock_type']."',reason='".$_POST['pending_reason']."',close_rmk='".$_POST['close_reason']."',close_tat='".$close_tat."',warranty_status='".$_POST['warranty_status']."',warranty_card='".$_POST['warrantycard']."',invoice_no='".$_POST['invoice_no']."',manufacter_date ='".$_POST['manufacterdate']."',doc_type='".$_POST['closetype']."',customer_satif='".$_POST['custumer_pay']."' ,".$inslladate." pen_status='".$st_status."',eng_id='' where job_no='".$jobno."'");}
	else{
