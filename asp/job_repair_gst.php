...
function addNewRowEp(findex){
    ...
    //// check if previous row is filled with these three values (fault code,repair code, part)/////
       ...
       var newdiv = document.createElement('div');
       newdiv.setAttribute("id",divIdName);
	   newdiv.innerHTML = "<i class='fa fa-close fa-lg' onclick='getRowDisableEp("+num+");getCost_service();' title='Remove this row'></i><table width='100%' class='table table-bordered'><tbody><tr align='left'><td width='20%'><select name='esti_part["+num+"]' class='form-control' id='esti_part["+num+"]' style='width:250px;' onChange='getData_esti(this.value,"+num+");' ><option value='' selected='selected'> Select Estimate Part</option><?php $z=0;while($z<count($parcode_arr)){?><option value='<?=$parcode_arr[$z][0]?>'><?=$parcode_arr[$z][1]?> ( <?=$parcode_arr[$z][0]?> )</option><?php $z++;}?></select></td><td width='12%'><input name='ep_cost["+num+"]' id='ep_cost["+num+"]' type='text'  class='form-control' style='width:100px;text-align:right' value='0.00' readonly /></td><td width='10%'><input name='ep_hsn_code["+num+"]' id='ep_hsn_code["+num+"]' type='text'  class='form-control' style='width:100px;text-align:right' value='' readonly /></td><td width='8%'><input name='ep_cgstper["+num+"]' id='ep_cgstper["+num+"]' type='text'  class='form-control' style='width:75px;text-align:right' value='0.00' readonly /></td><td width='8%'><input name='ep_cgstamt["+num+"]' id='ep_cgstamt["+num+"]' type='text'  class='form-control' style='width:85px;text-align:right' value='0.00' readonly /></td><td width='8%'><input name='ep_sgstper["+num+"]' id='ep_sgstper["+num+"]' type='text'  class='form-control' style='width:75px;text-align:right' value='0.00' readonly /></td><td width='8%'><input name='ep_sgstamt["+num+"]' id='ep_sgstamt["+num+"]' type='text'  class='form-control' style='width:80px;text-align:right' value='0.00' readonly /></td><td width='8%'><input name='ep_igstper["+num+"]' id='ep_igstper["+num+"]' type='text'  class='form-control' style='width:75px;text-align:right' value='0.00' readonly /></td><td width='8%'><input name='ep_igstamt["+num+"]' id='ep_igstamt["+num+"]' type='text'  class='form-control' style='width:80px;text-align:right' value='0.00' readonly /></td><td width='10%'><input name='ep_totalamt["+num+"]' id='ep_totalamt["+num+"]' type='text' class='form-control' style='width:100px;text-align:right' value='0.00' readonly /></td></tr></tbody></table>";
       ni.appendChild(newdiv);
	//}
}
...
function getRowDisableEp(ind) {
	...
	document.getElementById("ep_cgstper"+"["+ind+"]").value="";
	document.getElementById("ep_cgstamt"+"["+ind+"]").value="";
	document.getElementById("ep_sgstper"+"["+ind+"]").value="";
	document.getElementById("ep_sgstamt"+"["+ind+"]").value="";
	document.getElementById("ep_igstper"+"["+ind+"]").value="";
	document.getElementById("ep_igstamt"+"["+ind+"]").value="";
...
function getData_esti(val,indx){
	$.ajax({
		...
		var ep_cgstper = "ep_cgstper["+fldIndx1+"]";
		var ep_sgstper = "ep_sgstper["+fldIndx1+"]";
		var ep_igstper = "ep_igstper["+fldIndx1+"]";
		var ep_cgstamt = "ep_cgstamt["+fldIndx1+"]";
		var ep_sgstamt = "ep_sgstamt["+fldIndx1+"]";
		var ep_igstamt = "ep_igstamt["+fldIndx1+"]";
		...
		if(data != ""){
			...
			document.getElementById(ep_cgstper).value = resval[2];
			document.getElementById(ep_sgstper).value = resval[3];
			document.getElementById(ep_igstper).value = resval[4];
			document.getElementById(ep_cgstamt).value = resval[5];
			document.getElementById(ep_sgstamt).value = resval[6];
			document.getElementById(ep_igstamt).value = resval[7];
			document.getElementById(ep_totalamt).value = resval[8];		
		}
		getCost_service();
		/*for(var i=0; i <= fldIndx1; i++){
			...
			var ep_cgsttotal=ep_cgsttotal+parseFloat(document.getElementById(c1).value);
			var ep_sgsttotal=ep_sgsttotal+parseFloat(document.getElementById(c2).value);
			var ep_igsttotal=ep_igsttotal+parseFloat(document.getElementById(c3).value);
			var ep_tot_cost=ep_tot_cost+parseFloat(document.getElementById(c4).value);
			var ep_grandtotal=ep_grandtotal+parseFloat(document.getElementById(c5).value);
		}*/
		/*document.getElementById("cgsttotal").value=ep_cgsttotal;
		document.getElementById("sgsttotal").value=ep_sgsttotal;
		document.getElementById("igsttotal").value=ep_igsttotal;
		document.getElementById("tot_cost").value=ep_tot_cost;
		document.getElementById("grandtotal").value=ep_grandtotal;
		document.getElementById("ep_new_es").value=ep_grandtotal;*/
	    }
	});
}
function getCost_service(){
	...
	var customerstat = "<?=$job_row['state_id']?>";
	var stat = "<?=$_SESSION['stateid']?>";
	if(customerstat != stat){
	...
	for(var i=0;i<=numi;i++){
		...
		var c4="ep_cost["+i+"]";
		var c5="ep_totalamt["+i+"]";
		if(document.getElementById(c1).value){ var epcgstamt=parseFloat(document.getElementById(c1).value);}else{ var epcgstamt=0.00;}
		if(document.getElementById(c2).value){ var epsgstamt=parseFloat(document.getElementById(c2).value);}else{ var epsgstamt=0.00;}
		if(document.getElementById(c3).value){ var epigstamt=parseFloat(document.getElementById(c3).value);}else{ var epigstamt=0.00;}
		...
		var cgsttotal=cgsttotal+epcgstamt;	
		var sgsttotal=sgsttotal+epsgstamt;
		var igsttotal=igsttotal+epigstamt;
		var tot_cost=tot_cost+epcostamt;
		var grandtotal=grandtotal+eptotamt;
	}		
	if(document.getElementById('cgst_ser_tax_amt').value){
		var cgst_srv = parseFloat(document.getElementById('cgst_ser_tax_amt').value);
	}else{ 
		var cgst_srv = 0.00;
	}
	...
	if(document.getElementById('taotal_ser_tax_amt').value){var newes_srv = parseFloat(document.getElementById('taotal_ser_tax_amt').value);}else{ var newes_srv = 0.00;}
      ...
      <div class="col-sm-9">
        ...
        <div class="form-group"  id="page-wrap" style="margin-left:10px;" >
          ...
          <div class="tab-content">
            ...
            <form  name="frm1" id="frm1" class="form-horizontal" action="job_repair_save.php" method="post"><br/>
              <div class="form-group">
                <div class="col-md-6"><label class="col-md-5">Repair Status <span class="red_small">*</span></label>
                  <div class="col-md-6">
                    <select name="jobstatus" id="jobstatus" onChange="return change_stat(this.value);" class="required form-control" style="width:250px;" required>
                      ...
                      <?php
							 $res_jobstatus = mysqli_query($link1,"select status_id, display_status from jobstatus_master where status_id=main_status_id and system_status in ('BER','EP','PNA','Repair Done','RWR','Replacement','SFR','WIP') order by display_status");
                ...
                <div class="col-md-6"><label class="col-md-6">Repair Remark <span class="red_small">*</span></label>
                  <div class="col-md-6">
                    <textarea name="rep_remark" id="rep_remark" required class="form-control" onkeypress = " return ( (event.keyCode ? event.keyCode : event.which ? event.which : event.charCode)!= 13);"  onContextMenu="return false" style="resize:none"></textarea>
                  </div>
                </div>
    ...
    ?>
                  ...
                  <div id="ep" style="display:none"><br/>
                    <table width="100%" class="table table-bordered">
                     <thead> 
                      <tr>
                        <td width="20%"><strong>Estimated Part</strong></td>
                        <td width="12%"><strong>Part Cost</strong></td>
                        <td width="10%"><strong>HSN Code</strong></td>
                        <td width="8%"><strong>CGST %</strong></td>
                        <td width="8%"><strong>CGST Amt</strong></td>
                        <td width="8%"><strong>SGST %</strong></td>
                        <td width="8%"><strong>SGST Amt</strong></td>
                        <td width="8%"><strong>IGST %</strong></td>
                        <td width="8%"><strong>IGST Amt</strong></td>
                     ...
                     <tbody> 
                      <tr>
                        ...
                        <td><input name="ep_cost[0]" id="ep_cost[0]" type="text"  class="form-control" style="width:100px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_hsn_code[0]" id="ep_hsn_code[0]" type="text"  class="form-control" style="width:100px;text-align:right" value="" readonly /></td>
                        <td><input name="ep_cgstper[0]" id="ep_cgstper[0]" type="text"  class="form-control" style="width:75px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_cgstamt[0]" id="ep_cgstamt[0]" type="text"  class="form-control" style="width:80px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_sgstper[0]" id="ep_sgstper[0]" type="text"  class="form-control" style="width:75px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_sgstamt[0]" id="ep_sgstamt[0]" type="text"  class="form-control" style="width:80px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_igstper[0]" id="ep_igstper[0]" type="text"  class="form-control" style="width:75px;text-align:right" value="0.00" readonly /></td>
                        <td><input name="ep_igstamt[0]" id="ep_igstamt[0]" type="text"  class="form-control" style="width:80px;text-align:right" value="0.00" readonly /></td>
                  ...
                  <br/>              
                    ...
                    <tbody>
                  	<tr>
    				 <td width="20%"><div style="width:250px;"><strong>Service Charge</strong></div></td>
    				 <td width="12%"><input name="ser_charge" type="text" class="number form-control" id="ser_charge" onBlur="getCost_service()" style="width:100px;" /></td>
    				 <td width="10%"><?php
					//$sql_ware="select * from location_master where location_code='".$job_row['location_code']."'";
					//$row_asc=mysql_fetch_array(mysql_query($sql_ware));
					$st = mysqli_fetch_array(mysqli_query($link1,"SELECT igst,sgst,cgst,hsn_code FROM tax_hsn_master where hsn_code='998716' and status='Active'")) ;?>
					<input name="ser_tax_hsn" type="text" class="form-control" id="ser_tax_hsn" value="<?php echo $st['hsn_code']; ?>"  readonly="readonly" style="width:100px;" /></td>
					<?php if($job_row['state_id']!=$_SESSION['stateid']){ ?>
                    <td width="8%"><input name="cgst_ser_tax_per" type="text" class="form-control" id="cgst_ser_tax_per" value="0.00"  readonly="readonly" style="width:75px;" /></td>
                    <td width="8%"><input name="cgst_ser_tax_amt" type="text" class="form-control" id="cgst_ser_tax_amt"  value="0.00" readonly style="width:80px;" /></td>
                    <td width="8%"><input name="sgst_ser_tax_per" type="text" class="form-control" id="sgst_ser_tax_per"  value="0.00"readonly="readonly" style="width:75px;" /></td>
                    <td width="8%"><input name="sgst_ser_tax_amt" type="text" class="form-control" id="sgst_ser_tax_amt" value="0.00" readonly style="width:80px;" /></td>
                    <td width="8%"><input name="igst_ser_tax_per" type="text" class="form-control" id="igst_ser_tax_per" value="<?php if($st['igst']){echo $st['igst'];}else{ echo "0.00";} ?>" readonly style="width:75px;" /></td>
                    <td width="8%"><input name="igst_ser_tax_amt" type="text" class="form-control" id="igst_ser_tax_amt" value="0.00" readonly style="width:80px;" /></td>
					<?php }else{?>
                    <td width="8%"><input name="cgst_ser_tax_per" type="text" class="form-control" id="cgst_ser_tax_per" value="<?php if($st['cgst']){echo $st['cgst'];}else{ echo "0.00";} ?>" readonly style="width:75px;" /></td>
                    <td width="8%"><input name="cgst_ser_tax_amt" type="text" class="form-control" id="cgst_ser_tax_amt"  value="0.00" readonly style="width:80px;" /></td>
                    <td width="8%"><input name="sgst_ser_tax_per" type="text" class="form-control" id="sgst_ser_tax_per"  value="<?php if($st['sgst']){echo $st['sgst'];}else{ echo "0.00";} ?>"readonly="readonly" style="width:75px;" /></td>
                    <td width="8%"><input name="sgst_ser_tax_amt" type="text" class="form-control" id="sgst_ser_tax_amt" value="0.00" readonly style="width:80px;" /></td>
                    <td width="8%"><input name="igst_ser_tax_per" type="text" class="form-control" id="igst_ser_tax_per" value="0.00" readonly style="width:75px;" /></td>
                    <td width="8%"><input name="igst_ser_tax_amt" type="text" class="form-control" id="igst_ser_tax_amt" value="0.00" readonly style="width:80px;" /></td>
					<?php }?>    
    				<td width="10%"><input name="taotal_ser_tax_amt" type="text" class="form-control" id="taotal_ser_tax_amt"  value="0.00" readonly style="width:100px;" /></td>
  				</tr>
  			  </tbody>
  			  </table>
              <table width="100%" class="table">
                 <tbody>  
                  <tr>
                    ...
                    <td width="10%"><input name="tot_cost" type="text" class="form-control" id="tot_cost" value="0.00" readonly style="width:100px;text-align:right"/></td>
                    <td width="10%"><strong>CGST Amt</strong></td>
                    <td width="10%"><input name="cgsttotal" type="text" class="form-control" id="cgsttotal" value="0.00" readonly style="width:100px;text-align:right"  /></td>
                    <td width="10%"><strong>SGST Amt</strong></td>
                    <td width="10%"><input name="sgsttotal" type="text" class="form-control" id="sgsttotal" value="0.00" readonly style="width:120px;text-align:right" /></td>
                    <td width="10%"><strong>IGST Amt</strong></td>
                    <td width="10%"><input name="igsttotal" type="text" class="form-control" id="igsttotal" value="0.00"  readonly="readonly" style="width:120px;text-align:right" /></td>
                    <td width="10%"><strong>Total Amt</strong></td>
                    <td width="10%"><input name="grandtotal" type="text" class="form-control" id="grandtotal" value="0.00" readonly style="width:120px;text-align:right"/>
                		...
                		<tr>
                  			...
                  			<td>
                    			<select name="repair_code_replace" id="repair_code_replace" style="width:200px;" class="required form-control">
                                 	<option value="" selected="selected"> Select Repair code</option>
                                   	<?php 
									$sql = "SELECT rep_code,rep_desc FROM repaircode_master where rep_desc = 'Replacement' and status='Active'";
									$res = mysqli_query($link1,$sql);
									if(mysqli_num_rows($res)>0){
										while($row = mysqli_fetch_array($res)){
									?>		
									<option value="<?=$row[0]?>"><?php echo $row[1]."(".$row[0].")";?></option>
									<?php
										}
									}
									?>                                    
