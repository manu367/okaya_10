...
$(document).ready(function() {
	var dataTable = $('#sfr_assignlist-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/sfr_assign-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".sfr_assign-grid-error").html("");
				$("#sfr_assign-grid").append('<tbody class="sfr_assign-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
				$("#sfr_assign-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-list-alt"></i> Assign </h2>
      <?php if($_REQUEST['msg']){?>
	...
	?>
       ...
       <table  width="100%" id="sfr_assignlist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              <th>S.No</th>
              <th>ASP Location</th>
