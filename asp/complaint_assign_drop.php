...
$error_msg="";
   ...
   //////////////////////////////// Insert call  history//////////////////////////////////////
    $flag2 = callHistory($_POST['job_no'],$_SESSION['asc_code'],"6","Assigned to Engineer/Delivery- Drop","Assigned to Engineer",$eng_name,$ws,$_REQUEST['els_status'],"","",$ip,$link1,$flag);

	  
	  /////////////////////////////////////Job Sheet data////////////////////////////////////////////////////////
	 
   $up_job=mysqli_query($link1,"update jobsheet_data set sub_status='2',status='6',eng_id='".$eng_name."' ,pen_status='2' where job_no='".$_POST['job_no']."'" );
...
/*  $send_sms_to_eng = file_get_contents("http://sms.foxxglove.com/api/mt/SendSMS?user=cancrm&password=123456&senderid=CANCRM&channel=Trans&DCS=0&flashsms=0&number=".$eng_det["contactmo"]."&text=".$msg_to_eng);*/
  $cflag="success";
		...
		mysqli_commit($link1);
	header("location:$page_link.php?msg=".$msg."&chkflag=".$cflag."&chkmsg=".$cmsg."&smsmsg=".base64_encode($sms_msg)."&to=".$cust_det['mobile']."&status=2".$pagenav);
  }
...
<div class="container-fluid">
  <div class="row content">
    ...
    ?>
   <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-list-alt"></i> Job Assign (Drop)</h2>
    ...
    <div class="panel panel-info table-responsive">
      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
            <tbody>
            <tr>
              <td width="49%"><label class="control-label">Engineer/Delivery Person Name </label></td>
