...
<script>
    ...
    TreeView.prototype.addNode = function(value){
    ...
    TreeView.prototype.removeNode = function(value){
    ...
    TreeView.prototype.updateNode = function(oldValue,newValue){
        const node = this.searching(oldValue);
        if(node){
            node.data = newValue;
            return true;
        }
    ...
    TreeView.prototype.children = function(value){
        const node = this.searching(value);
        if(!node) return null;
        return {
            left: node.left ? node.left.data : null,
            right: node.right ? node.right.data : null
        }
    }
    TreeView.prototype.searching = function(value){
        let current = this.root;
        while(current !== null){
    ...
    TreeView.prototype.maximum = function(){
        let current = this.root;
    ...
    TreeView.prototype.minimum = function(){
        let current = this.root;
    ...
    TreeView.prototype.heightofTree = function(node = this.root){
        if(node === null) return -1;
        const left = this.heightofTree(node.left);
        const right = this.heightofTree(node.right);
        return Math.max(left, right) + 1;
    }
    TreeView.prototype.depthofNode = function(value){
        let current = this.root;
        let depth = 0;
        while(current !== null){
    ...
    TreeView.prototype.countNode = function(node = this.root){
        if(node === null) return 0;
        return 1 +
            this.countNode(node.left) +
            this.countNode(node.right);
    }
    TreeView.prototype.mergeTree = function(otherTree){
        const insertAll = (node)=>{
            if(node === null) return;
            this.addNode(node.data);
            insertAll(node.left);
            insertAll(node.right);
        }
        insertAll(otherTree.root);
    }
    TreeView.prototype.inorder = function(node){
        if(node !== null){
    ...
    TreeView.prototype.preorder = function(node){
        if(node !== null){
            console.log(node.data);
    ...
    TreeView.prototype.postorder = function(node){
        if(node !== null){
    ...
    TreeView.prototype.travel = function(type){
        if(type === "inorder"){
    ...
    tree.addNode(50);tree.addNode(30);tree.addNode(70);
    tree.addNode(20);tree.addNode(40);tree.addNode(24);
    tree.addNode(19);tree.addNode(81);tree.addNode(39);
    tree.addNode(45);tree.addNode(1);tree.addNode(-20);
   console.log(tree);
</script>
<?php
