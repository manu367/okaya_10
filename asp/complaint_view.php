...
?></td>
  ...
  <table class="table table-bordered" width="100%">
        ...
        <div class="text-center">
            <a href="inventory_imei_details.php?pid=<?=$_REQUEST['pid']?>&hid=<?=$_REQUEST['hid']?>" class="btn btn-success" style="text-align: center">Back</a>
        </div>
...
?>
    ...
    <script>
        const image=document.querySelectorAll("#frm1 img");
