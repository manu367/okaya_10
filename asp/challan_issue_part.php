        ...
        <table class="table table-bordered" width="100%">
            ...
            <!--  <tr>  <form id="frm1" name="frm1" class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
              ...
              <tr>
                 ...
                 <td colspan="4" align="center"><input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='assgin_part_user.php?daterange=<?=$_REQUEST['daterange']?>&status=<?=$_REQUEST['status']?>&doc_type=<?=$_REQUEST['doc_type']?><?=$pagenav?>'"></td>
                </tr>
            </tbody>
          </table>
      </div><!--close panel body-->
