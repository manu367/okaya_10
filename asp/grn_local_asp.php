...
$(document).ready(function() {
	var dataTable = $('#asc-grnlocal-grid').DataTable( {
		...
		"order": [[ 4, "desc" ]],
		"ajax":{
			url :"../pagination/grnlocal-grid-data_asp.php", // json datasource
			...
			error: function(){  // error handling
				...
				$("#asc-grnlocal-grid").append('<tbody class="asc-grnlocal-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
  ...
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New GRN" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='grn_local_add_asp.php?op=Add<?=$pagenav?>'"><span>Add New GRN</span></button>&nbsp;&nbsp;
