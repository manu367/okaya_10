                            ...
                            <table class="table table-bordered" width="100%">
                                ...
                                for($j=0; $j<count($jobno_arr); $j++){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div align="center">
                                                <a href="complaint_view_only.php?refid=<?=($jobno_arr[$j])?>"
                                                title='view'>
                                                <i class='fa fa-eye fa-lg faicon' title='view job details'></i>
                                                </a>
                                            </div>
                        ...
                        <div align="center">
                            <form id="frm4" name="frm4" class="form-horizontal" action="" method="">
                                ...
                                <input title="Make complaint with serial" type="button" id="makecomplaint"
                                       ...
                                       onClick="window.location.href='complaint_make_live.php?<?=$pagenav?>&mobileno=<?=($_REQUEST['mobileno'])?>&customer_id=<?=$_REQUEST['customer_id']?>&email_id=<?=$_REQUEST['email_id']?>&imei_serial=<?=$_REQUEST['imei_serial']?>'">
                            </form>
                        </div>
                    </div>
                </div>
