...
<?php }?>
$(document).ready(function() {
	var dataTable = $('#sfr_qc_joblist-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/sfr_qc_job-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".sfrjob_qc-grid-error").html("");
				$("#sfrjob_qc-grid").append('<tbody class="sfrjob_qc-grid-error"><tr><th colspan="13">No data found in the server</th></tr></tbody>');
				$("#sfrjob_qc-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-list-alt"></i> Jobs QC </h2>
      <?php if($_REQUEST['msg']){?>
	...
	?>
       ...
       <table  width="100%" id="sfr_qc_joblist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
