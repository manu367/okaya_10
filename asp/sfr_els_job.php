...
$(document).ready(function() {
	var dataTable = $('#sfr_elslist-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/sfr_els-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				$(".sfr_els-grid-error").html("");
				$("#sfr_els-grid").append('<tbody class="sfr_els-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
				$("#sfr_els-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-list-alt"></i> ELS </h2>
      <?php if($_REQUEST['msg']){?>
	...
	?>
       ...
       <table  width="100%" id="sfr_elslist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              <th>S.No</th>
              <th>ASP Location</th>
