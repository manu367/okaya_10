...
if($_REQUEST['to']!='' && ( $_REQUEST['status']==6 || $_REQUEST['status']=="HG" ||  $_REQUEST['status']=="2"   ))
	...
	<!--<iframe src="http://203.212.70.200/smpp/sendsms?username=lazer&password=lazer7891&to=<?=$_REQUEST['to']?>&from=LAZERC&text=<?=base64_decode($_REQUEST['smsmsg'])?>"  width="1" height="1" scrolling="No" style="background:#00FF33"></iframe>-->
<?php }?>
