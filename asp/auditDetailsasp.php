      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
         <thead>	
			...
			<tr>
                 <td width="100%" align="center" colspan="5"><input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='asp_audit_details.php?<?=$pagenav?>'"></td>
               </tr>  
          </table>
      </div><!--close panel body-->
    </div><!--close panel-->
