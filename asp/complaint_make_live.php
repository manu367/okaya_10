    ...
    <script>
        ...
        $(document).ready(function () {
            $('#pop_date').datepicker({
                ...
                document.getElementById("warraty_date").value = expiryDate;
                document.getElementById("install_date").value=selectedDate.getFullYear()+"-"+selectedDate.getMonth()+"-"+selectedDate.getDate();
                document.getElementById("warranty_status").value="IN";
                document.getElementById("warranty_status1").vlue="IN";
            });
        });
