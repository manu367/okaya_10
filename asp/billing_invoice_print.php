...
$location_info_from = explode("~",getAnyDetails($po_row['from_location'],"locationname,locationaddress,cityid","location_code","location_master",$link1));
...
<!--	<page size="A4" layout="portrait"></page>-->
	...
	<page size="A4">
		...
		<table class="table" style="margin-bottom: 0px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="15%"><img src="../images/blogo.png" width="200px"/></td>
        ...
        <div align="center" class="lable"><u><strong><?php if($po_row['document_type']=="DC"){ echo "Delivery Challan"; $str = "Challan";}else{ echo "Tax Invoice";$str = "Invoice";}?></strong></u></div>
        ...
        <table class="table" border="1" style="margin-bottom: 0px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2"><?=$po_row['to_location'];?></td>                
              ...
              <tr>
                ...
                <td colspan="2"><?=$po_row['driver_contact'];?></td>
			  ...
			  <?php /*?> <tr>
                ...
                <td colspan="2"><strong>E-Way Bill Date</strong></td>

                <td colspan="2"><?=dt_format($po_row['eway_billdate']);?></td>

                <td colspan="2"><strong>E-Way Remark</strong></td>

                <td colspan="2"><?=$po_row['eway_billremark']?></td>
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <thead>
              ...
              <td width="10%"><strong>Serial No.</strong></td>
          ...
          <tbody>
			...
			while($podata_row=mysqli_fetch_assoc($podata_res)){
				...
				$product_name = explode("~", getAnyDetails($podata_row['partcode'],"part_name,product_id,brand_id,hsn_code","partcode","partcode_master",$link1)); 
			...
			?>   
                ...
                <tr>
                	...
                	<td colspan="<?=$colspn?>" align="right"><strong> Amount</strong></td>
				 ...
				 <tr>
                	...
                	<td colspan="<?=$colspn?>" align="right"><strong>Pay Amount</strong></td>
