...
<title>OKAYA CARE - a Service Management System</title>
...
<body style="height:800px">
  ...
  <br>
   ...
   <span class="button_text" style="background-color:#FFF3CD">  Always  verify the URL before entering the Credentials!  </span>
  ...
  <br>
    ...
    <div class="field_container">
      <input type="Password" placeholder="Password" name="pwd"   id="pwd"  >
       ...
       toggle="#pwd"
       style="position: absolute; right: 8px; top: 60%; transform: translateY(-50%); cursor: pointer;">
    </i>
