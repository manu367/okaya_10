...
$doc_type = base64_decode($_REQUEST['doc_type']);
...
<!--	<page size="A4" layout="portrait"></page>-->
	<page size="A4">
		<table class="table" style="margin-bottom: 0px;">
            <tbody>
              <tr>
                <td width="20%"><img src="../images/blogo.png" width="200px"/></td>
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			$podata_sql="SELECT * FROM billing_product_items where challan_no='".$po_row['challan_no']."' and from_location='".$_SESSION['asc_code']."'";
