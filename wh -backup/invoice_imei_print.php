...
$location_info_from = explode("~",getAnyDetails($po_row['from_location'],"locationname","location_code","location_master",$link1));
...
<!--	<page size="A4" layout="portrait"></page>-->
	<page size="A4">
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
            <tbody>
              <tr>
                <td width="15%" colspan="2"><strong>Challan No.</strong></td>
                <td width="35%" colspan="2"><?=$docid?></td>
                <td width="15%" colspan="2"><strong>Challan  Date</strong></td>
			  ...
			  <td colspan="2"><strong>Status</strong></td>
                ...
                <td colspan="2"><?=$po_row['billing_remark'];?></td>				
              </tr> 
			  <tr>
			  ...
			  <tr>
			  <td colspan="2"><strong>Doc Type</strong></td>
                <td colspan="2"><?=$po_row['document_type'];?></td>
                <td colspan="2"><strong>Type</strong></td>
                <td colspan="2"><?=$po_row['po_type'];?></td>				
              </tr>   
              <tr>
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			/////////////////////////// fetching data from data table /////////////////////////////////////////////////////////////////////////
		     $podata_sql = "SELECT * FROM imei_details where  challan_no='".$docid."'";
