...
$(document).ready(function() {
	var dataTable = $('#emp-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/loc-wh-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-users"></i> <?=$locationstr?> List </h2>
	  ...
	  <form class="form-horizontal" role="form" name="form1" action="" method="get">
        ...
        <div class="form-group">
		  ...
		  <div class="col-md-6">
               ...
               User Report : <a href="excelexport.php?rname=<?=base64_encode("locationmaster_wh")?>&rheader=<?=base64_encode("Admin User Master")?>&u_type=<?=base64_encode($_GET['u_type'])?>&status=<?=base64_encode($_GET['status'])?>" title="Export user details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export user details in excel"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   
			   <!---
			   User Mapping : <a href="excelexport.php?rname=<?=base64_encode("loc_map_master")?>&rheader=<?=base64_encode("User Mapping Master")?>&u_type=<?=base64_encode($_GET['u_type'])?>&status=<?=base64_encode($_GET['status'])?>" title="Export mapping details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export mapping details in excel"></i></a>
			   ---->
