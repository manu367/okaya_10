...
if($po_row["po_type"]=="GRNR"){
$to_name=getAnyDetails($row['to_location'],"name","id","vendor_master",$link1);
$location_info_to = explode("~",getAnyDetails($po_row['to_location'],"name,bill_address,phone","id","vendor_master",$link1));

}else{
$location_info_to = explode("~",getAnyDetails($po_row['to_location'],"locationname,locationaddress,contactno1","location_code","location_master",$link1));
...
<!--	<page size="A4" layout="portrait"></page>-->
	<page size="A4">
		<table class="table" style="margin-bottom: 0px;">
            <tbody>
              <tr>
                <td width="20%"><img src="../images/blogo.png" width="100px"/></td>
        ...
        <div align="center" class="lable"><u><strong><?php if($po_row['document_type']=="DC"){ echo "Delivery Challan"; $str = "Challan";}else if($po_row['document_type']=="INV"){ echo "Invoice";$str = "Invoice";}else{
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
            <tbody>
			  ...
			  <td colspan="2"><strong>Address</strong></td>
                ...
                <td colspan="2"><strong>Address</strong></td>
                <td colspan="2"><?php if($po_row["po_type"]=="GRNR"){ echo $location_info_to['1'];} else{
				echo $po_row['deliv_addrs'];}?><br/>Phone No.-<?=$location_info_to['2']?></td>				
              </tr>
              <tr>
              ...
              <tr>
			   ...
			   <tr>
                <td colspan="2"><strong>Courier.</strong></td>
                <td colspan="2"><?=$po_row['courier']?></td>
                <td colspan="2"><strong>Docket No.</strong></td>
                <td colspan="2"><?=$po_row['docket_no']?></td>
              </tr>
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			while($podata_row=mysqli_fetch_assoc($podata_res)){
				...
				$product_name = explode("~", getAnyDetails($podata_row['partcode'],"part_name,product_id,brand_id,hsn_code,vendor_partcode,model_id","partcode","partcode_master",$link1)); 
				
						$part= explode(",",$product_name['5']); 
			...
			if($po_row['to_stateid']==$po_row['from_stateid']){ $colspn=12; }else{ $colspn=10;}
			?>   
            	<tr>
                ...
                <tr>
                	<td colspan="<?=$colspn?>" align="right"><strong>Total Qty</strong></td>
               	  <td>&nbsp;</td>
                ...
                <tr>
                  <td colspan="<?=$colspn+1?>"><strong>Amount in Words: </strong>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-inr" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo number_to_words($value) . " Only"; ?></td>
                </tr>
                <tr>
		...
		<table class="table" border="1">
           <tbody>         
              <tr>          
                <td colspan="8" align="left" style="vertical-align:bottom;border-bottom:none" height="50">Company's PAN :  <strong>AADCR9806P</strong></td>
              </tr>
              <tr>        
		...
		<p align="center">SUBJECT TO DELHI JURISDICTION</p>
