...
<div class="container-fluid">
 <div class="row content">
   ...
   <div class="panel-group">
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading">Items Information
                   </div>
      <div class="panel-body">
       <table class="table table-bordered" width="102%">
            <thead>
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading">Receive
                      </div>
      <div class="panel-body">
        <table class="table table-bordered" width="100%">
            <tbody>          
               <tr>
			   <td width="10%">&nbsp;</td>
                 <td width="15%"><span class="control-label">Receive Remark <span style="color:#F00">*</span></span></td>
                   <td width="57%">   <textarea  name="rcv_rmk" id="rcv_rmk" class="form-control required" readonly/><?=$po_row['opration_rmk'];?></textarea></td>
                 <td width="18%"></td>
