		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				var dataTable = $('#joblist-grid').DataTable( {
					...
					"order": [[ 0, "desc" ]],
					"ajax":{
						url :"../pagination/advance_docket_uploader-grid-data.php", // json datasource
		...
		<div class="container-fluid">
			<div class="row content">
				...
				<div class="<?=$screenwidth?> tab-pane fade in active" id="home">
					<h2 align="center"><i class="fa fa-tags"></i> Advance Docket Upload</h2>
					<?php if($_REQUEST['msg']){?>
					...
					<form class="form-horizontal" role="form" name="form1" action="" method="get">
							...
							<div class="col-md-6"><label class="col-md-5 control-label">Date Range</label>	  
								<div class="col-md-6 input-append date" align="left">
									...
									<div style="display:inline-block;float:right">
										<i class="fa fa-calendar fa-lg"></i></div>
								</div>
							</div>
							<div class="col-md-6"><label class="col-md-4 control-label">ASP NAME</label>	  
							<div class="col-md-6" align="left">
									<select name="assign_to" id="assign_to" class="form-control" onChange="document.form1.submit();">
										<option value="">All</option>
										<?php
											$res_asp = mysqli_query($link1,"SELECT location_code, locationname FROM location_master WHERE locationtype='ASP' AND statusid='1' ORDER BY locationname");
                        ...
                        <?php if($_SESSION['id_type']=='WH'){  //// Uploader Option will show only WH ID  ?>  
						<div class="form-group">
							
							<div class="col-md-12">	  
								<div class="col-md-12">
									<div style="display:inline-block;float:right">
                                    <a href="upload_advance_docket.php" class="btn btn-primary">Upload Advance Docket</a>
                                    </div>
								</div>
							</div>
						</div><!--close form group-->
