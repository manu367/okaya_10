...
$po_sql = "SELECT * FROM billing_master where po_no='" . $docid . "' and to_location='".$_SESSION['asc_code']."'";
$po_res = mysqli_query($link1, $po_sql);
$po_row = mysqli_fetch_assoc($po_res);
////// get location details
$location_info_from = explode("~",getAnyDetails($po_row['from_location'],"name,address","id","vendor_master",$link1));
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			$podata_sql="SELECT * FROM billing_product_items where request_no='".$docid."' and to_location='".$_SESSION['asc_code']."'";
