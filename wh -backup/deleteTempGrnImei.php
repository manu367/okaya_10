...
if($result){
	...
	header("Location:enter_imei.php?refid=".base64_encode($po_no)."&partcode=".base64_encode($partcode)."&pqty=".base64_encode($qty)."&partname=".base64_encode($productdet)."&grn_type=".$_REQUEST['grn_type']."".$pagenav);
}
?>