...
// js -> website , mobile application , desktop , backend , shopify , microsoft development(powerbi plugin , excel-plugin ),chrome developement
// java ->  backend , mobiel application , desktop
