...
$po_sql = "SELECT * FROM billing_master where challan_no='" . $docid . "' and (po_type='CLAIM' or po_type='ENTITY LABOUR CLAIM')";
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td width="15%" colspan="2"><strong>Bill No.</strong></td>
              ...
              <tr>
                ...
                <td colspan="8" align="left"><i class="fa fa-desktop fa-lg"></i><strong style="font-size:14px"> LEVEL DETAIL</strong></td>
          ...
          <thead>
              ...
              <td width="3%">#</td>
			   <td width="17%"><strong>Product</strong></td>
			    <td width="17%"><strong>Brand</strong></td>
				 <td width="17%"><strong>Model</strong></td>

              <td width="17%"><strong>TAT</strong></td>
          ...
          <tbody>
			...
			?>
              ...
              <tr>
                ...
                <td><?=$i?></td>
				 <td align="left"><?=getAnyDetails($claim_row['product_id'],"product_name","product_id","product_master",$link1)?></td>
						 <td align="left"><?=getAnyDetails($claim_row['brand'],"brand","brand_id","brand_master",$link1)?></td>
						<td align="left"><?=$claim_row['model']?> </td>

                <td><?=$claim_row['level']?></td>
			...
			if($po_row['to_stateid']==$po_row['from_stateid']){ $colspn=15; }else{ $colspn=10;}
