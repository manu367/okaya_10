    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
	  ...
	  <form class="form-horizontal" role="form" name="form1" action="" method="get">
       ...
       <?php if ($_REQUEST['Submit']){?>
        ...
        <?php }?>
         <button title="Upload MSL Qty" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='mslqty_uploader.php?op=add<?=$pagenav?>'"><span>Upload MSL Qty</span></button><br/>
