...
$(document).ready(function() {
	var dataTable = $('#audit-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/audit-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				...
				$("#audit-grid").append('<tbody class="audit-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
  ...
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      ...
      <form class="form-horizontal" role="form">
        <button title="Audit Planning" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_auditplanning.php?op=Add<?=$pagenav?>'"><span>Audit Planning</span></button>&nbsp;&nbsp;
