...
if ($_POST['save']=='Save'){
	//// initialize transaction parameters
		...
		$error_msg="";
		$total_score=$_POST['customerConveninceScore1']+$_POST['customerConveninceScore2']+$_POST['customerConveninceScore3'];
		//////// update score in main table ///////////////////////////	
		$sql1=mysqli_query($link1,"Update audit_details set tot_audit_1='".$total_score."' , update_by='".$_SESSION['userid']."' ,update_date = '".$today."' where request_no='".$request_no."' " );
	...
	////////////////////// insert into  Audit1 Customer Convenience Table///////////////
			$sql2=mysqli_query($link1,"insert into  audit_1 set  sc1='".$_POST['customerConveninceScore1']."',sc2='".$_POST['customerConveninceScore2']."',sc3='".$_POST['customerConveninceScore3']."',total_score='".$total_score."',update_by='".$_SESSION['userid']."',update_date='".$today."',status='update', request_no = '".$request_no."' , location_code = '".$location."' ,requestdate = '".$today."'   ");
			//// check if query is not executed
		if (!$sql2) {
			 $flag = false;
			 $error_msg = "Error details1: " . mysqli_error($link1) . ".";
	...
	$flag = dailyActivity($_SESSION['userid'],$request_no,"Customer Convenience","Insert Score",$_SERVER['REMOTE_ADDR'],$link1,$flag);
		
		///// check both master and data query are successfully executed
		if ($flag) {
			mysqli_commit($link1);
			$msg="Successfully updated Customer Convience Score of ".$request_no;
			$cflag="success";
			$cmsg="Success";
		} else {
  ...
  <script type="text/javascript" src="../js/moment.js"></script>
   ...
   function setMarks(){
	 	...
	 	for(var id=1;id<4;id++){
		 	var val=eval("document.auditForm.customerConveninceScore"+id+".options[document.auditForm.customerConveninceScore"+id+".selectedIndex].value");
	 		if(val!=''){
...
<div class="container-fluid">
 <div class="row content">
  ...
  include("../includes/leftnav2.php");
    ?>
   <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-balance-scale"></i>Customer Convience </h2>
   ...
   <div class="panel-group">
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading"><i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;Infrastructure >> Customer Convenience  </div>
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
            <tbody>              
            <tr>
			<td width="5%"  align="center">SNo</strong></td>
              ...
              <td width="6%" align="center"><strong>Marks</strong></td>
			...
			<td width="5%">1</td>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="customerConveninceScore1"  id="customerConveninceScore1"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
             <td width="5%">2</td>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="customerConveninceScore2"  id="customerConveninceScore2"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
              ...
              <td width="6%" align="center">4</td>
			   <td width="15%"><select name="customerConveninceScore3"  id="customerConveninceScore3"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="4">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
              ...
              <td width="30%"></td>
              <td width="15%" align="center"><div id=totalScore></div></td>
			   <td width="15%"></td>			 
            </tr>
			<tr>
