<?php
global $screenwidth, $btncolor, $link1;
...
<script>
    ...
    function DataListners(name) {
        this.name = name;
    }
    DataListners.prototype = Object.create(Observer.prototype);
    DataListners.prototype.constructor = DataListners;
    DataListners.prototype.update = function (subject) {
        console.log(this.name + " received data:", subject.getData());
    };
    function InventoryObserver() {
        this.observers = [];
        this.data = null;
    }
    InventoryObserver.prototype = Object.create(Subject.prototype);
    InventoryObserver.prototype.constructor = InventoryObserver;
    InventoryObserver.prototype.attach = function (observer) {
        this.observers.push(observer);
    };
    InventoryObserver.prototype.detach = function (observer) {
        this.observers = this.observers.filter(o => o !== observer);
    };
    InventoryObserver.prototype.notify = function () {
        this.observers.forEach(observer => {
            observer.update(this);
        });
    };
    InventoryObserver.prototype.setData = function (data) {
        this.data = data;
        this.notify();
    };
    InventoryObserver.prototype.getData = function () {
        return this.data;
    };
    function objectSharing(){
        return this;
    }
    const inventory = new InventoryObserver();
    const listener1 = new DataListners("Warehouse System");
    const listener2 = new DataListners("Billing System");
    inventory.attach(listener1);
    inventory.attach(listener2);
    inventory.setData({
        partcode: "P00009",
        qty: 4222
    });
