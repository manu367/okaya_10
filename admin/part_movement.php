...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/stock-mov-data_admin.php", // json datasource
			data: { "pid": "<?=$_REQUEST['pid']?>", "hid": "<?=$_REQUEST['hid']?>", "product_name": "<?=$_REQUEST['product_name']?>", "brand": "<?=$_REQUEST['brand']?>", "location_code": "<?=$_REQUEST['location_code']?>", "modelid": "<?=$_REQUEST['modelid']?>","daterange": "<?=$_REQUEST['daterange']?>"},
			type: "post",  // method  , by default get
			error: function(){  // error handling
				$(".job-grid-error").html("");
				$("#job-grid").append('<tbody class="job-grid-error"><tr><th colspan="16">No data found in the server</th></tr></tbody>');
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-cubes"></i> Stock Movement</h2>
       ...
       <table  width="100%" id="joblist-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              ...
              <th>SRN IN</th>
              <th>SRN OUT</th>
              <th>Adjustment Plus</th>
              <th>Adjustment Minus</th>
              <th>Stock Issue To ENG</th>
			   <th>Receive From ENG</th>
              <th>Close</th>
