...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/job-grid-data-doa.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h3 align="center"><i class="fa fa-check-square"></i> DOA APPROVAL</h3>
      <?php if($_REQUEST['msg']){?>
         ...
         <div class="col-md-6"><label class="col-md-5 control-label">Date Range</label>	  
		  ...
		  <div class="col-md-6"><label class="col-md-4 control-label">Job Status</label>	  
			<div class="col-md-5" align="left">
			  <select id="example-multiple-selected" multiple="multiple" name="job_status[]" id="job_status[]" class="form-control">
				<?php
                $res_status = mysqli_query($link1,"select status_id, display_status, main_status_id from jobstatus_master where status_id in('9','91','92','93','94') order by display_status")or die(mysqli_error($link1)); 
        ...
        <div class="form-group">
         <div class="col-md-6"><label class="col-md-5 control-label"><?=$locationstr?></label>	  
			<div class="col-md-6">
                ...
                <?php
				$res_pro = mysqli_query($link1,"select location_code,locationname from location_master where locationtype in ('ASP','L3') and statusid='1'"); 
		...
		//// array initialization to send by query string of  status
		 ...
		 <div class="form-group">
		  <div class="col-md-10"><label class="col-md-4 control-label"></label>	  
			<div class="col-md-6" align="left">	
               <a href="../excelReports/doa_report.php?daterange=<?=$_REQUEST['daterange']?>&location_code=<?=base64_encode($_REQUEST['location_code']);?>&status=<?=base64_encode($statusstr);?>" title="Export DOA details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export DOA details in excel"></i></a>
            </div>
          </div>
	    </div><!--close form group-->
		  <?php }?>
