...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/job-grid-data-req_serial_change.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h3 align="center"><i class="fa fa-check-square"></i> DOP/SERIAL CHANGE REQUEST APPROVAL</h3>
      <?php if($_REQUEST['msg']){?>
	  ...
	  <form class="form-horizontal" role="form" name="form1" action="" method="get">
	   <!----
		  ...
		  <div class="col-md-6"><label class="col-md-4 control-label"><!---Job Status---></label>	  
			...
			<?php /* ?>
			  <select id="example-multiple-selected" multiple="multiple" name="job_status[]"  class="form-control">
				<?php
                $res_status = mysqli_query($link1,"select status_id, display_status, main_status_id from jobstatus_master where status_id in('70','71','72') order by display_status")or die(mysqli_error($link1)); 
        ...
        <div class="form-group">
		  ...
		  <div class="col-md-6"><label class="col-md-4 control-label">Product</label>	  
			<div class="col-md-6" align="left">
