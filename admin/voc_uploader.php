...
error_reporting(E_ALL ^ E_NOTICE);
   ...
   /*echo '<script>alert("le fichier a �t� charg� avec succes !");</script>';*/
	...
	{
		///// gat data from excel field /////
		$voc_disc = $sheet->getCellByColumnAndRow(0,$row)->getValue();
		if($voc_disc!=''){					
		$usr_add = "INSERT INTO voc_master set product_id = '".$prod_code."', brand_id = '".$brand."', status = '1' , voc_desc = '". $voc_disc."' , voc_cat = '".$voc_disc."' ";
		...
		$req_res = mysqli_query($link1,"UPDATE voc_master set voc_code='".$newVOCcode."' where id='".$insid."'");
		//// check if query is not executed
		if (!$req_res) {
			 $flag = false;
		...
		$flag = dailyActivity($_SESSION['userid'],$newVOCcode,"VOC","ADD",$_SERVER['REMOTE_ADDR'],$link1,$flag);
		} //////////// END for VOC Blank IF Condition
	}////// end of for loop
  ...
  <div class="row content">
   ...
   include("../includes/leftnav2.php");
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-upload"></i>Upload New VOC </h2>
      <div style="display:inline-block;float:right"><a href="../templates/UPLOAD_VOC.xlsx" title="Download Excel Template"><img src="../images/template.png" title="Download Excel Template"/></a></div>	<br></br> 
