...
$(document).ready(function() {
	var dataTable = $('#joblist-grid').DataTable( {
		...
		//"order": [[ 0, "asc" ]],
		"ajax":{
			url :"../pagination/stock-list-data-admin.php", // json datasource
