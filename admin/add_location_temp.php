...
$useraccess=cleanData($userid);
   // insert all details of location //

	$usr_code="select locationid from location_master where location_code='".$useraccess."'";
		$result_user=mysqli_query($link1,$usr_code);
		///// if found \\\\\
		if (mysqli_num_rows($result_user)==0){

   $sql="INSERT INTO location_master set erpid='".$erp_id."', othid='".$oth_id."',locationname='".ucwords($party_name)."',locationtype='".$party_type."', partner_type='".$propritortype."', contact_person='".ucwords($contact_person)."',landlineno='".$helpline_no."',emailid='".$email."',contactno1='".$phone1."',contactno2='".$phone2."',locationaddress='".ucwords($address)."',dispatchaddress='".ucwords($address)."',deliveryaddress='".ucwords($address)."',districtid='".$locationdistrict."',cityid='".$locationcity."',stateid='".$locationstate."',countryid='".$country."',zipcode='".$pincode."',statusid='1',loginstatus='1',gstno='".$gst_no."',panno='".$pan_no."',oth_taxr_no='".$othtaxr_no."',oth_tax_name='".$othtax_name."',createby='".$_SESSION['userid']."',createdate='".$datetime."',price_lvl='".$part_price."',entity_type='".$entity_code."',zone='".$zone."'";
   ...
   if($insid != ""){
   		...
   		if($to_location_info['emailid']!=""){
			...
			$toemail =$to_location_info['emailid'].",".'singhvikas270@gmail.com'.",".'jitugupta20121989@gmail.com'."";
...
$msg="This user id already present Please check. ".$userid;
}
