...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() {
		var dataTable = $('#joblist-grid').DataTable( {
			...
			"order": [[ 0, "desc" ]],
			"ajax":{
				url :"../pagination/asptat_pending.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h3 align="center"><i class="fa fa-check-square"></i>Daily All Complaints Aging Wise </h3>
      <?php if($_REQUEST['msg']){?>
        ...
        <div class="form-group">
          <div class="col-md-10">
            ...
            <div class="col-md-6" align="left"> 
			   ...
			   <a href="excelexport.php?rname=<?=base64_encode("ASP_tat_pending_report")?>&rheader=<?=base64_encode("State TAT ")?>&modelid=<?=$_GET['modelid']?>&state=<?=$_GET['state']?>&daterange=<?=$_GET['daterange']?>" title="Export employees details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export employees details in excel"></i></a> </div>
          </div>
        </div>
        <!--close form group-->
        <?php }?>
