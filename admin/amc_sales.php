...
//echo "select SUM(amc_amount) as amcamt, model_id from amc where ".$loc_condi." and ".$prod_condi." and ".$daterange." group by model_id";
$res_sale = mysqli_query($link1,"select SUM(amc_amount) as amcamt, model_id from amc where ".$loc_condi." and ".$prod_condi." and ".$daterange." group by model_id");
while($row_sale = mysqli_fetch_assoc($res_sale)){
	$part_name = getAnyDetails($row_sale['model_id'],"model","model_id","model_master",$link1);
	if($amc_str1){
		$amc_str1 .= ",'".$part_name."'";
		$amc_str2 .= ",".$row_sale["amcamt"]."";
	}else{
		$amc_str1 .= "'".$part_name."'";
		$amc_str2 .= "".$row_sale["amcamt"]."";
	}
...
<div class="container-fluid">
    ...
    ?>
    	<div class="col-sm-9">
        	<h2 align="center"><i class="fa fa-area-chart"></i> AMC Sales</h2><br/>
