...
$res_cust=mysqli_query($link1,"SELECT * FROM customer_master where customer_id='".$getid."'")or die(mysqli_error($link1));
...
<div  class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <div class="col-sm-12 tab-pane fade in active" id="home">
    ...
    <div class="panel panel-info table-responsive">
        ...
        <table class="table table-bordered" width="100%">
         <thead>	
				...
				$res_locdet=mysqli_query($link1,"SELECT from_location,to_location,challan_no,sale_date,total_cost,status,logged_by as entry_by  FROM billing_master where to_location='".$getid."'")or die(mysqli_error($link1));
      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
         <thead>	
				...
				$k=1;
				////// get details of customer  for purchase  ////
				$res_pay=mysqli_query($link1,"SELECT * FROM payment_receive_loc where location_code='".$getid."'")or die(mysqli_error($link1));
      ...
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
         <thead>	
				...
				////// get details of customer  for purchase  ////
				$res_ledger=mysqli_query($link1,"SELECT * FROM location_account_ledger where location_code='".$getid."' order by entry_date desc")or die(mysqli_error($link1));
