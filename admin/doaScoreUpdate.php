...
if ($_POST['save']=='Save'){
	//// initialize transaction parameters
		...
		$error_msg="";
		$total_score=$_POST['doaScore1']+$_POST['doaScore2'];
		
		//////// update score in main table ///////////////////////////	
		$sql1=mysqli_query($link1,"Update audit_details set tot_audit_8='".$total_score."' , update_by='".$_SESSION['userid']."' ,update_date = '".$today."' where request_no='".$request_no."' " );
	...
	////////////////////// ///////////////////// insert into  Audit8 DOA Table//////////////////////////////
		$sql2=mysqli_query($link1,"insert into  audit_8 set sc1='".$_POST['doaScore1']."',sc2='".$_POST['doaScore2']."',total_score='".$total_score."',update_by='".$_SESSION['userid']."',update_date='".$today."',status='update', request_no = '".$request_no."' , location_code = '".$location."' ,requestdate = '".$today."'   ");
			//// check if query is not executed
		if (!$sql2) {
			 $flag = false;
			 $error_msg = "Error details1: " . mysqli_error($link1) . ".";
	...
	$flag = dailyActivity($_SESSION['userid'],$request_no,"DOA","Insert Score",$_SERVER['REMOTE_ADDR'],$link1,$flag);
		
		///// check both master and data query are successfully executed
		if ($flag) {
			mysqli_commit($link1);
			$msg="Successfully inserted DOA Score of ".$request_no;
			$cflag="success";
			$cmsg="Success";
		} else {
  ...
  <script type="text/javascript" src="../js/moment.js"></script>
   ...
   function setMarks(){
	 	...
	 	for(var id=1;id<3;id++){
		 	var val=eval("document.auditForm.doaScore"+id+".options[document.auditForm.doaScore"+id+".selectedIndex].value");
	 		if(val!=''){
...
<div class="container-fluid">
 <div class="row content">
  ...
  include("../includes/leftnav2.php");
    ?>
   <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-balance-scale"></i>DOA</h2>
   ...
   <div class="panel-group">
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading"><i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;Infrastructure >>DOA</div>
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
            <tbody>              
            <tr>
			...
			<td width="5%">1</td>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="doaScore1"  id="doaScore1" onChange="setMarks()" class="form-control"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
             <td width="5%">2</td>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="doaScore2"  id="doaScore2"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
