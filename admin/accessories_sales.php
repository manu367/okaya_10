...
while($row_sale = mysqli_fetch_assoc($res_sale)){
	...
	if($accessories_str){
		$accessories_str .= ",['".$part_name."', ".$row_sale['saleqty']."]";
	}else{
		$accessories_str .= "['".$part_name."', ".$row_sale['saleqty']."]";
	}
}
...
<div class="container-fluid">
    ...
    ?>
    	<div class="col-sm-9">
        	<h2 align="center"><i class="fa fa-line-chart"></i>ASP Parts Sales</h2><br/>
        ...
        <div class="col-md-6"><label class="col-md-5 control-label">Product</label>
         ...
         <div class="col-md-6"><label class="col-md-5 control-label">Parts</label>	  
			<div class="col-md-6" align="left" id="proddiv">
				<select name="product" id="product" class="form-control">
              		<option value="">All</option>
                    <?php 
					$res_prod = mysqli_query($link1,"select partcode,part_name from partcode_master where brand_id in (".$arrbrand.") and product_id in (".$arrproduct.") and status='1'  order by part_name"); 
					while($row_prod = mysqli_fetch_assoc($res_prod)){ 
					?>		
