...
////// pick max no. of Customer
   $query_code="select MAX(max_id) as qa from customer_master";
  ...
  $sql="INSERT INTO customer_master set customer_id='".$newcustomercode."',tempid='".$code_id."',customer_name='".$_REQUEST[name]."',address='".$address."',city='".$city."',state='".$state."',country='".$country."',contactno='".$_REQUEST[phone]."',emailid='".$_REQUEST[email]."',status='Active',mapplocation='".$location."',createby='".$_SESSION['userid']."',createdate='".$today."',category='".$_REQUEST[cat]."' , gstin = '".$_POST['gstin']."' ";
      ...
      <div class="form-group"  id="page-wrap" style="margin-left:10px;" >
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <div class="col-md-6"><label class="col-md-5 control-label">Customer Type<span class="red_small">*</span></label>
              ...
              <div class="col-md-6" >
	            <input type="text" name="gstin" id="gstin"  class="alphanumeric form-control "   maxlength="10">
			  </div>
            </div>
          ...
          <div class="form-group">
            <div class="col-md-12" align="center">
              ...
              <input title="Back" type="button" class="btn btn-primary" value="Back" onClick="window.location.href='customer_list.php'">
            </div>
          </div>
    </form>
      </div>
