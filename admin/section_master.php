...
$(document).ready(function() {
	var dataTable = $('#voc-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/section-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-bug"></i> Section Master</h2>
      <?php if($_REQUEST['msg']){?>
        ...
        <div class="form-group">
		  ...
		  <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			<div class="col-md-5" align="left">
			   ...
			   ?>
               <a href="excelexport.php?rname=<?=base64_encode("sectionmaster")?>&rheader=<?=base64_encode("Section Master")?>&status=<?=base64_encode($_GET['status'])?>" title="Export Section details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export Section details in excel"></i></a>
               <?php
				//}
				?>
            </div>
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New Section" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_section.php?op=Add<?=$pagenav?>'"><span>Add New Section</span></button>&nbsp;&nbsp;
