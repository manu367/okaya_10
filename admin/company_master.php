	...
	var dataTable = $('#company-grid').DataTable( {
		...
		"ajax":{
			...
			error: function(){  // error handling
				...
				$("#company-grid").append('<tbody class="company-grid-error"><tr><th colspan="4">No data found in the server</th></tr></tbody>');
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9 tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-user-circle"></i> Company Master</h2>
      ...
      <div class="form-group">
		  ...
		  <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			<div class="col-md-5" align="left">
			   ...
			   ?>
               <a href="excelexport.php?rname=<?=base64_encode("companymaster")?>&rheader=<?=base64_encode("Company Master")?>&status=<?=base64_encode($_GET['status'])?>" title="Export company details in excel"><i class="fa fa-file-excel-o fa-2x faicon" title="Export company details in excel"></i></a>
               <?php
				//}
				?>
            </div>
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New Company" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_company.php?op=Add<?=$pagenav?>'"><span>Add New Company</span></button>&nbsp;&nbsp;
        <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
      <!--<div class="form-group table-responsive"  id="page-wrap" style="margin-left:10px;"><br/><br/>-->
       <table  width="100%" id="company-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
            <tr>
              <th>S.No</th>
              <th>Company Name</th>
