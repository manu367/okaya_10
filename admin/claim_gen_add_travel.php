...
//echo "select claim_mnth , location_code from claim_invoice where claim_mnth LIKE '%".$_POST['claim_month']."%' and location_code = '".$locationname."'  and status != '5' ";
  $numcount	= mysqli_query($link1, "select claim_mnth , location_code from claim_invoice where claim_mnth LIKE '%".$_POST['claim_month']."%' and location_code = '".$locationname."'  and status != '5' ");
