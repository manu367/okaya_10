...
$(document).ready(function() {
	var dataTable = $('#bank-grid').DataTable( {
		...
		"order": [[ 2, "asc" ]],
		"ajax":{
			url :"../pagination/bank-grid-data.php", // json datasource
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-bank"></i> Bank Master</h2>
      <?php if($_REQUEST['msg']){?>
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New bank" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='add_bank.php?op=Add<?=$pagenav?>'"><span>Add New bank </span></button>&nbsp;&nbsp;
