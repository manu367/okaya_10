...
<option value='<?=$i?>' <?php if($_REQUEST['year']==$i) echo "selected";?> ><?=$i?></option>";
        ...
        <?php if ($_REQUEST['Submit']){
		  ...
		  <div class="col-md-6"><label class="col-md-5 control-label"></label>	  
			...
			<br><br/>	 
	<form class="form-horizontal" role="form" method="post" action="claim_gen_add_travel_entity.php">
	...
	<div class="panel-body">
           ...
           <thead>
			...
			<td><strong>Cost</strong></td>
			 ...
			 <tbody>
				  ...
				  $sql_travel = mysqli_query($link1,"SELECT *,sum(travel_km) as sum_travel FROM job_claim_appr  where entity_type = '". $loc_row['entity_type']."'   and  app_status='Y' and hand_date like '%$sel_month%'  and et_claim_no='' group by entity_type");
		...
		?>
					  ...
					  <tr> <td  colspan="2"  align="right">Total</td><td ><?php echo $row_trvl['sum_travel']; ?></td><td >&nbsp;</td><td ><?php echo $total_travl; ?></td><td></td></tr>
                        <input type="hidden" name="row_count"  id="row_count" value="2" />
                      

       <tr><td align="center" colspan="6">  <input type="submit" class="btn<?=$btncolor?>" name="upd" id="upd" value="Generate" title="Generate Claim">
