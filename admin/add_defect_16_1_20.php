...
if($_POST){
    ...
    ///////// insert model data	   
    $usr_add="INSERT INTO defect_master set product_id ='".$product_name."', brand_id ='".$brand_name."', defect_desc='".$defect."' ,status='".$status."',defect_code='".$defect_code."'";
 ...
 $usr_upd = "Update defect_master set product_id ='".$product_name."', brand_id ='".$brand_name."', defect_desc='".$defect."' ,status='".$status."' where defect_code='".$getid."'";
