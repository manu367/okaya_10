...
$(document).ready(function() {
	var dataTable = $('#claim-job').DataTable( {
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/claim-job-grid-data.php", // json datasource
			...
			error: function(){  // error handling
				...
				$("#claim-job").append('<tbody class="claim-job-error"><tr><th colspan="7">No data found in the server</th></tr></tbody>');
