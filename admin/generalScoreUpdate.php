...
if ($_POST['save']=='Save'){
	//// initialize transaction parameters
		...
		$error_msg="";
		$total_score=$_POST['generalScore1']+$_POST['generalScore2']+$_POST['generalScore3']+$_POST['generalScore4']+$_POST['generalScore5'];
		
		//////// update score in main table ///////////////////////////	
		$sql1=mysqli_query($link1,"Update audit_details set tot_audit_7='".$total_score."' , update_by='".$_SESSION['userid']."' ,update_date = '".$today."' where request_no='".$request_no."' " );
	...
	////////////////////// ///////////////////// insert into  Audit2 Manpower Table//////////////////////////////
		$sql2=mysqli_query($link1,"insert into  audit_7 set sc1='".$_POST['generalScore1']."',sc2='".$_POST['generalScore2']."',sc3='".$_POST['generalScore3']."',sc4='".$_POST['generalScore4']."',sc5='".$_POST['generalScore5']."',total_score='".$total_score."',update_by='".$_SESSION['userid']."',update_date='".$today."',status='update', request_no = '".$request_no."' , location_code = '".$location."' ,requestdate = '".$today."'   ");
			//// check if query is not executed
		if (!$sql2) {
			 $flag = false;
			 $error_msg = "Error details1: " . mysqli_error($link1) . ".";
	...
	$flag = dailyActivity($_SESSION['userid'],$request_no,"General","Insert Score",$_SERVER['REMOTE_ADDR'],$link1,$flag);
		
		///// check both master and data query are successfully executed
		if ($flag) {
			mysqli_commit($link1);
			$msg="Successfully inserted General Score of ".$request_no;
			$cflag="success";
			$cmsg="Success";
		} else {
  ...
  <script type="text/javascript" src="../js/moment.js"></script>
   ...
   function setMarks(){
	 	...
	 	for(var id=1;id<6;id++){
		 	var val=eval("document.auditForm.generalScore"+id+".options[document.auditForm.generalScore"+id+".selectedIndex].value");
	 		if(val!=''){
...
<div class="container-fluid">
 <div class="row content">
  ...
  include("../includes/leftnav2.php");
    ?>
   <div class="col-sm-9">
      <h2 align="center"><i class="fa fa-balance-scale"></i>General </h2>
   ...
   <div class="panel-group">
    ...
    <div class="panel panel-info table-responsive">
      <div class="panel-heading"><i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;Infrastructure >>General  </div>
      <div class="panel-body">
       <table class="table table-bordered" width="100%">
            <tbody>              
            <tr>
			...
			<td width="5%">1</td>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="generalScore1"  id="generalScore1" onChange="setMarks()" class="form-control"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
             <td width="5%">2</td>
              ...
              <td width="6%" align="center">2</td>
			   <td width="15%"><select name="generalScore2"  id="generalScore2"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="2">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="generalScore3"  id="generalScore3"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="generalScore4"  id="generalScore4"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
			...
			<tr>
              ...
              <td width="6%" align="center">1</td>
			   <td width="15%"><select name="generalScore5"  id="generalScore5"  class="form-control" onChange="setMarks()"><option value="">Select</option><option value="1">TRUE</option><option value="0">FALSE</option></select></td>
