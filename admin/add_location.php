...
if($_POST['Submit']=='Save')
{
	...
	$newlocationcode="OP".$party_type.$pad;
	...
	if($insid != "")
	{
		...
		if($to_location_info['emailid']!=""){
			...
			$message.="<tr><td>Su-kam CRM Team</td></tr>";
			$message.="</table>";
...
<html>
	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			/////////// function to get Unique Location Code
			function checkDupliLoccode(val){
				//alert("hey");
				var fyr=$('#location_user_code').val();
				//alert(fyr);
				$.ajax({
					type:'post',
					url:'../includes/getAzaxFields.php',
					...
					success:function(data){
						...
						if(data>0){
							alert("Duplicate Location code");
							$('#location_user_code').val('');
						}
					}
				});
	...
	$country_query="SELECT * FROM country_master where status = 'A' order by countryname";
						 ...
						 while($br_country = mysqli_fetch_array($check_country)){
									...
									<div class="col-md-6"><label class="col-md-6 control-label">Party Type <span class="red_small">*</span></label>
										...
										<div class="col-md-6">
											...
											<select name="party_type" id="party_type" class="form-control required" required>
												...
												$lctype_query="SELECT * FROM  location_type_master where status='1' order by displayname";
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<label class="col-md-6 control-label">Party Name <span class="red_small">*</span></label></label>
									<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-6"><label class="col-md-6 control-label">CIN</label>
							...
							<div class="form-group">
								...
								<div class="col-md-6"><label class="col-md-6 control-label">ERP/SAP Code <span class="red_small">*</span></label>

									<div class="col-md-6">

										<input name="erp_id" type="text" class="form-control required" required id="erp_id">
								...
								<div class="col-md-6"><label class="col-md-6 control-label">Other Code</label>
									...
									<div class="col-md-6">
										...
										<input name="oth_id" type="text" class="form-control alphanumeric" id="oth_id" maxlength="30">
