...
$po_sql = "SELECT * FROM billing_master where challan_no='" . $docid . "' and (po_type='ENTITY TRAVEL CLAIM' or po_type='TRAVEL CLAIM')";
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <thead>
              ...
              <td width="17%"><strong>Claim Type </strong></td>

            

              <td width="10%"><strong> Distance(In Km)</strong></td>
          ...
          <tbody>
			...
			if($po_row['to_stateid']==$po_row['from_stateid']){ $colspn=12; }else{ $colspn=7;}
