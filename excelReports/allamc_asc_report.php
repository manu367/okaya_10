...
$sql_loc = mysqli_query($link1,"Select * from amc where location_code='".$_SESSION['asc_code']."' and (update_date >= '".$fromdate."' and update_date <='".$todate."') ".$model_id."  ".$product_id." ".$brand_id."");
...
header('Content-Disposition: attachment;filename="allamc_asc_report.xlsx"');
