...
$objPHPExcel->setActiveSheetIndex(0)
           ...
           ->setCellValue('C1', 'Asc Address')
			...
			->setCellValue('M1', 'Part Code')
			->setCellValue('N1', 'Vendor Part Code')
...
$count=1;
if($pending == 'checked'){
$sql_loc = mysqli_query($link1,"Select * from po_master where to_code ='".$_SESSION['asc_code']."' and status = '1'  and potype in ('PO' ,'PNA') ");
}
else{
...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('N'.$i, $partinfo[1])
			->setCellValue('O'.$i, $partinfo[0] )
...
header('Content-Disposition: attachment;filename="pendingpo.xlsx"');
