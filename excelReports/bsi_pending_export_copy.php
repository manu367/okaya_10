...
//    {
//        $sql    = "SELECT * FROM admin_users WHERE status='1' AND designation_id='45' {$condition}";
...
//    {
//        $where = " WHERE ar.userid = '" . mysqli_real_escape_string($this->connection, $username) . "' ";
