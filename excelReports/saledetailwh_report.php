...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('X1', 'To Location Code')
			->setCellValue('Y1', 'To Location');
////////////////
///////////////////////
cellColor('B1', 'F28A8C');
cellColor('A1', 'F28A8C');
...
cellColor('X1', 'F28A8C');cellColor('Y1', 'F28A8C');
////////////////////////////////
///////////////////////////////////////////////
...
$objPHPExcel->setActiveSheetIndex(0)
			...
			->setCellValue('X'.$i, $row_loc['to_location'])
			->setCellValue('Y'.$i, getAnyDetails($row_loc['to_location'],"locationname","location_code","location_master",$link1));
			$count++;
...
header('Content-Disposition: attachment;filename="saledetailwh_report.xlsx"');
