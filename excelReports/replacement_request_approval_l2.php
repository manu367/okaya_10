...
//echo "Select * from jobsheet_data where ext1 = 'Replacement Request' and ".$locationcode." and ".$status." and ".$daterange." and ".$productid." and ".$brandid." and ".$modelid;exit;
	...
	$sql_loc = mysqli_query($link1,"Select * from jobsheet_data where ext1 = 'Replacement Request' and ext7 > '90' and state_id in ($access_state) and ".$locationcode." and ".$status." and ".$daterange." and ".$productid." and ".$brandid." and ".$modelid);
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Replacement_req_appr_l2');
...
header('Content-Disposition: attachment;filename="replacement_request_approval_l2.xlsx"');
