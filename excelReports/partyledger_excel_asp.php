...
$result_row = mysqli_query($link1,"select sum(amount) as amt from  location_account_ledger where location_code='".$a."' and   entry_date <= '".$fromdate."' and crdr='".$b."'  order by entry_date,id");
