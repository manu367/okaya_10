...
$i=2;
$sql_loc=mysqli_query($link1,"Select * from location_account_ledger where (entry_date >= '".$fromdate."'  and entry_date <='".$todate."') and $locationcode");
...
header('Content-Disposition: attachment;filename="partyledgerasp_report.xlsx"');
