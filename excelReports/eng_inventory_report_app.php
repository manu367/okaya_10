...
$i=2;
$count =1;
$sql_loc=mysqli_query($link1,"SELECT a.*, b.part_name, b.product_id, b.brand_id, b.customer_price FROM user_inventory a, partcode_master b where 1 ".$locationid." and a.partcode=b.partcode ".$productid." ".$brandid."  ".$modelid." ");
