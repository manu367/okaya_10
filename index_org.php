...
/*if($user_browser == "Safari"){
	echo "<div align='center'>This Browser is not compatible for LAZER CRM</div>";
}else{*/
...
<body>
  ...
  <div id="dont_have_an_account">
    <DIV align="center">Copyright © 2013-2022 . All Rights Reserved. Powered By : <A href="http://www.candoursoft.com/" target="_blank">CANDOUR SOFTWARE</A></DIV>
