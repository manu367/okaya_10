...
<div class="container-fluid">
 <div class="row content">
   ...
   <div class="<?=$screenwidth?> tab-pane fade in active">
      <h2 align="center"><i class="fa fa-inbox"></i> Stock In Receive with IMEI</h2><br/>
       ...
       <table class="table table-bordered" width="100%">
            <thead>
              <tr>
                ...
                <th style="text-align:center" width="15%" rowspan="2">IMEI Receive</th>
                </tr>
              <tr>
			...
			?>
              <tr>
                ...
                <td><?php if(  $podata_row['imei_attach'] == '' ){?><a href='inventory_stockin_imeisave_wh.php?refid=<?=base64_encode($podata_row['challan_no'])?>&partcode=<?=$podata_row['partcode'];?><?=$pagenav?>'  title='view'><i class="fa fa-eye fa-lg faicon" title="view details"></i></a><?php } else if($podata_row['imei_attach'] == 'R') {echo "IMEI Received";} else{ echo "IMEI Not Attached" ;}?></td>
                </tr>
            ...
            <td colspan="8" align="center"s>
                   <input title="Back" type="button" class="btn<?=$btncolor?>" value="Back" onClick="window.location.href='stock_in_salereturn.php?<?=$pagenav?>'"></td>
              </tr>
            </tbody>
          </table>
      </div><!--close panel body-->
