		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <thead>
             ...
             <?php if($po_row['total_igst_amt'] == '0.00'){?>
                <td width="6%"><strong>CGST %</strong></td>
				<td width="6%" ><strong>CGST Amt </strong></td>
				<td width="6%" ><strong>SGST %</strong></td>
				<td width="6%"><strong>SGST Amt </strong></td>
				<?php  } else {?>
				<td width="6%"><strong>IGST %</strong></td>
				<td width="6%" ><strong>IGST Amt</strong></td>
				<?php }?>
          ...
          <tbody>
            ...
            <tr align="right">
                ...
                <td>&nbsp;</td>
				<td>&nbsp;</td>
				<td align="right"><strong><?php echo currencyFormat($po_row['total_cgst_amt'])?></strong></td>
                <td align="right">&nbsp;</td>
				<td align="right"><strong><?php echo currencyFormat($po_row['total_sgst_amt'])?></strong></td>
				<?php } else {?>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td align="right"><strong><?php echo currencyFormat($po_row['total_igst_amt'])?></strong></td>
