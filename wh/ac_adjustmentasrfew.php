...
if ($_POST['save'] == 'Save') {
    ...
    $err_msg = "";
				...
				///// Insert into location_Acount ledger table
                 $query12 = "INSERT INTO location_account_ledger set location_code='".$_POST['location']."', transaction_type='A/C Adjustment',crdr='".$_POST['adjust_type']."',amount='".$_POST['amount']."',entry_date='".$today."',remark='".$_POST['remark']."' ,transcation_no = 'Adjustment' ";			
