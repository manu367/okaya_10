...
$po_sql = "SELECT * FROM billing_master where challan_no='" . $docid . "' and to_location='".$_SESSION['asc_code']."'";
      ...
      <table class="table" border="1" style="margin-bottom: 0px;">
		...
		<table class="table" border="1" style="margin-bottom: 0px;">
          ...
          <tbody>
			...
			$podata_sql="SELECT * FROM billing_product_items where challan_no='".$docid."' and to_location='".$_SESSION['asc_code']."'";
