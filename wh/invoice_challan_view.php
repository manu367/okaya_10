...
<script>
    function Quickview(name,view){
        this.name=name;
        this.view=view;
    }
    Quickview.prototype.view = function(){
        if(this.name==='show'){
            this.showView();
        }
        else{
    ...
    Quickview.prototype.showView=function(){
        console.log("showing the image easily");
    }

    Quickview.prototype.hideView=function(){
        console.log("hideing the image easily");
    }

    function NormalView(name,view,type='normal'){
        Quickview.call(this,name,view);
        this.type=type;
    }
    NormalView.prototype=Object.create(Quickview.prototype);
    NormalView.prototype.constructor=NormalView;
    NormalView.prototype.showView=function(){
        console.log("this is normal view -> showing the image easily");
    }


    const normalView=new NormalView("Normal View","Show","normal");
    normalView.showView();
</script>
</body>
</html>