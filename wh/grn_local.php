...
$(document).ready(function() {
	var dataTable = $('#wh-grnlocal-grid').DataTable( {
		"processing": true,
		"serverSide": true,
		"order": [[ 0, "desc" ]],
		"ajax":{
			url :"../pagination/grnlocal-grid-data.php", // json datasource
			data: { "pid": "<?=$_REQUEST['pid']?>", "hid": "<?=$_REQUEST['hid']?>", "daterange": "<?=$_REQUEST['daterange']?>", "status": "<?=$_REQUEST['status']?>"},
			type: "post",  // method  , by default get
			error: function(){  // error handling
				$(".wh-grnlocal-grid-error").html("");
				$("#wh-grnlocal-grid").append('<tbody class="wh-grnlocal-grid-error"><tr><th colspan="11">No data found in the server</th></tr></tbody>');
				$("#wh-grnlocal-grid_processing").css("display","none");
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="<?=$screenwidth?> tab-pane fade in active" id="home">
      <h2 align="center"><i class="fa fa-car"></i>&nbsp;Local GRN</h2>
      <?php if($_REQUEST['msg']){?>
      ...
      <form class="form-horizontal" role="form">
        <button title="Add New GRN" type="button" class="btn<?=$btncolor?>" style="float:right;" onClick="window.location.href='grn_local_add.php?op=Add<?=$pagenav?>'"><span>Add New GRN</span></button>&nbsp;&nbsp;
        <div class="form-group"  id="page-wrap" style="margin-left:10px;"><br/><br/>
      <!--<div class="form-group table-responsive"  id="page-wrap" style="margin-left:10px;"><br/><br/>-->
       <table  width="100%" id="wh-grnlocal-grid" class="display" align="center" cellpadding="4" cellspacing="0" border="1">
          <thead>
