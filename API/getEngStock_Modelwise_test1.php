...
$p_name=$db->getAnyDetails($row['partcode'],"customer_price,part_category,model_id,hsn_code,part_category,serial_part,part_group,part_name","partcode","partcode_master");
